...
function porto_page_meta_fields() {
	...
	return array(
		'show_featured_image'     => array(
			...
			'title'   => __( 'Show Featured Image', 'porto-functionality' ),
			'type'    => 'radio',
			'default' => '',
...
function porto_add_page_meta_boxes() {
	...
	if ( function_exists( 'add_meta_box' ) && $screen && 'post' == $screen->base && 'page' == $screen->id ) {
		add_meta_box( 'page-meta-box', __( 'Porto Page Options', 'porto-functionality' ), 'porto_page_meta_box', 'page', 'normal', 'high' );
		add_meta_box( 'view-meta-box', __( 'Porto View Options', 'porto-functionality' ), 'porto_page_view_meta_box', 'page', 'normal', 'low' );
		if ( ! empty( $porto_settings['show-content-type-skin'] ) ) {
			add_meta_box( 'skin-meta-box', __( 'Porto Skin Options', 'porto-functionality' ), 'porto_page_skin_meta_box', 'page', 'normal', 'low' );
		}
	}
}
