...
import PortoTypographyControl, {
  portoGenerateTypographyCSS,
...
import PortoStyleOptionsControl, {
  portoGenerateStyleOptionsCSS,
} from "./controls/style-options";
...
const portoDestroyCarousel = function ($slider) {
  $slider
    .find(".owl-stage")
    .css({ transform: "", width: "", height: "", "max-height": "" })
    .off(".owl.core");
...
if (
  "header" === porto_block_vars.builder_type ||
  "footer" === porto_block_vars.builder_type
) {
  try {
    ...
    edit: withSelect(function (select, props) {
      ...
      var inspectorControls = el(
        ...
        el(SelectControl, {
          ...
          value: attrs.view,
          options: [
            { label: __("Standard", "porto-functionality"), value: "" },
            {
              label: __("Read More Link", "porto-functionality"),
              value: "style-1",
            },
            { label: __("Post Meta", "porto-functionality"), value: "style-2" },
            {
              label: __("Read More Button", "porto-functionality"),
              value: "style-3",
            },
            {
              label: __("Side Image", "porto-functionality"),
              value: "style-4",
            },
            { label: __("Post Cats", "porto-functionality"), value: "style-5" },
          ],
          onChange: (value) => {
            props.setAttributes({ view: value });
          },
        }),
        (view == "style-1" || view == "style-3") &&
          el(SelectControl, {
            label: __("Author Name", "porto-functionality"),
            value: attrs.author,
            options: [
              { label: __("Standard", "porto-functionality"), value: "" },
              { label: __("Show", "porto-functionality"), value: "show" },
              { label: __("Hide", "porto-functionality"), value: "hide" },
            ],
            onChange: (value) => {
        ...
        view == "style-3" &&
          el(SelectControl, {
            ...
            options: [
              ...
              {
                label: __("Borders", "porto-functionality"),
                value: "btn-borders",
              },
            ],
            onChange: (value) => {
              props.setAttributes({ btn_style: value });
            },
          }),
        view == "style-3" &&
          el(SelectControl, {
            ...
            options: [
              ...
              { label: __("Small", "porto-functionality"), value: "btn-sm" },
              {
                label: __("Extra Small", "porto-functionality"),
                value: "btn-xs",
              },
            ],
            onChange: (value) => {
              props.setAttributes({ btn_size: value });
            },
          }),
        view == "style-3" &&
          el(SelectControl, {
            ...
            options: [
              ...
              {
                label: __("Primary", "porto-functionality"),
                value: "btn-primary",
              },
              {
                label: __("Secondary", "porto-functionality"),
                value: "btn-secondary",
              },
              {
                label: __("Tertiary", "porto-functionality"),
                value: "btn-tertiary",
              },
              {
                label: __("Quaternary", "porto-functionality"),
                value: "btn-quaternary",
              },
              { label: __("Dark", "porto-functionality"), value: "btn-dark" },
              { label: __("Light", "porto-functionality"), value: "btn-light" },
            ],
            onChange: (value) => {
              props.setAttributes({ btn_color: value });
            },
          }),
        el(SelectControl, {
        ...
        el(ToggleControl, {
          ...
          onChange: (value) => {
            props.setAttributes({ show_metas: value });
          },
        }),
        el(RangeControl, {
        ...
        el(RangeControl, {
          ...
          max: 8,
          onChange: (value) => {
            props.setAttributes({ items_desktop: value });
          },
        }),
        el(RangeControl, {
          ...
          max: 5,
          onChange: (value) => {
            props.setAttributes({ items_tablets: value });
          },
        }),
        el(RangeControl, {
          ...
          max: 3,
          onChange: (value) => {
            props.setAttributes({ items_mobile: value });
          },
        }),
        el(RangeControl, {
          ...
          max: 3,
          onChange: (value) => {
            props.setAttributes({ items_row: value });
          },
        }),
        el(ToggleControl, {
          ...
          onChange: (value) => {
            props.setAttributes({ slider_config: value });
          },
        }),
        attrs.slider_config &&
          el(ToggleControl, {
        ...
        attrs.slider_config &&
          ...
          el(SelectControl, {
            ...
            value: attrs.nav_pos,
            options: [
              { label: __("Middle", "porto-functionality"), value: "" },
              {
        ...
        attrs.slider_config &&
          attrs.show_nav &&
          ("" == attrs.nav_pos || "nav-bottom" == attrs.nav_pos) &&
          el(SelectControl, {
            ...
            options: [
              ...
              {
                label: __("Rounded", "porto-functionality"),
                value: "rounded-nav",
              },
              {
                label: __("Big & Full Width", "porto-functionality"),
                value: "big-nav",
              },
            ],
            onChange: (value) => {
              props.setAttributes({ nav_type: value });
            },
          }),
        attrs.slider_config &&
          attrs.show_nav &&
          el(ToggleControl, {
            ...
            onChange: (value) => {
              props.setAttributes({ show_nav_hover: value });
            },
          }),
        attrs.slider_config &&
          el(ToggleControl, {
            ...
            onChange: (value) => {
              props.setAttributes({ show_dots: value });
            },
          }),
        attrs.slider_config &&
          attrs.show_dots &&
          el(SelectControl, {
            ...
            options: [
              { label: __("Outside", "porto-functionality"), value: "" },
              {
                label: __("Besides Title", "porto-functionality"),
                value: "show-dots-title",
              },
              {
                label: __("Top right", "porto-functionality"),
                value: "show-dots-title-right",
              },
            ],
            onChange: (value) => {
              props.setAttributes({ dots_pos: value });
            },
          }),
        el(TextControl, {
          ...
          onChange: (value) => {
            props.setAttributes({ animation_type: value });
          },
          help: __(
            "Please check this url to see animation types.",
            "porto-functionality"
          ),
        }),
        el(
        ...
        el(TextControl, {
          ...
          onChange: (value) => {
            props.setAttributes({ animation_duration: value });
          },
        })
      );

      var hasPosts =
        Array.isArray(props.recentPosts) && props.recentPosts.length;
      ...
      if (!hasPosts) {
        return [
          ...
          el(
            ...
            !Array.isArray(props.recentPosts)
              ? el(Spinner, null)
              : __("No posts found!", "porto-functionality")
          ),
        ];
      }
                    ...
                    el(
                      ...
                      show_image &&
                        ...
                        el(
                          ...
                          {
                            className:
                              "post-image thumb-info thumb-info-hide-wrapper-bg mb-3",
                          },
                          el(
                            "span",
                            ...
                            el("img", {
                              ...
                              alt: __("Post Image", "porto-functionality"),
                            })
                          )
                        ),
                      show_metas &&
                        el(
                          "span",
                          { className: "meta-date" },
                          el("i", { className: "far fa-calendar-alt" }),
                          " " +
                      ...
                      el(
                        ...
                        el("i", { className: "fas fa-angle-right" })
                      )
                    )
                  );
                })
...
(function (
  ...
  const PortoCarousel = function (props) {
    useEffect(() => {
      ...
      const clientId = props.clientId;
      const $slider = jQuery("#block-" + clientId)
      ...
      responsive[1200] = {
        ...
        mergeFit: attrs.mergeFit,
      };
      if (lg)
        responsive[992] = {
          items: lg,
          loop: attrs.loop && count > lg ? true : false,
          mergeFit: attrs.mergeFit_lg,
        };
      if (md)
        responsive[768] = {
          items: md,
          loop: attrs.loop && count > md ? true : false,
          mergeFit: attrs.mergeFit_md,
        };
      if (sm)
        responsive[481] = {
          items: sm,
          loop: attrs.loop && count > sm ? true : false,
          mergeFit: attrs.mergeFit_sm,
        };
      if (xs)
        responsive[0] = {
          items: xs,
          loop: attrs.loop && count > xs ? true : false,
          mergeFit: attrs.mergeFit_xs,
        };
    ...
    var inspectorControls = el(
      ...
      el(RangeControl, {
        ...
        max: 100,
        onChange: (value) => {
          props.setAttributes({ stage_padding: value });
        },
      }),
      el(RangeControl, {
      ...
      attrs.autoplay &&
        el(TextControl, {
          ...
          onChange: (value) => {
            props.setAttributes({ autoplay_timeout: value });
          },
        }),
      attrs.autoplay &&
        el(ToggleControl, {
          ...
          onChange: (value) => {
            props.setAttributes({ autoplay_hover_pause: value });
          },
        }),
      el(RangeControl, {
      ...
      el(RangeControl, {
        ...
        max: 10,
        onChange: (value) => {
          props.setAttributes({ items_lg: value });
        },
      }),
      el(RangeControl, {
        ...
        max: 8,
        onChange: (value) => {
          props.setAttributes({ items_md: value });
        },
      }),
      el(RangeControl, {
        ...
        max: 5,
        onChange: (value) => {
          props.setAttributes({ items_sm: value });
        },
      }),
      el(RangeControl, {
        ...
        max: 3,
        onChange: (value) => {
          props.setAttributes({ items_xs: value });
        },
      }),
      el(ToggleControl, {
        label: __("Show Nav", "porto-functionality"),
      ...
      attrs.show_nav &&
        el(SelectControl, {
          ...
          options: [
            { label: __("Middle", "porto-functionality"), value: "" },
            {
              label: __("Middle of Images", "porto-functionality"),
            ...
            { label: __("Bottom", "porto-functionality"), value: "nav-bottom" },
          ],
          onChange: (value) => {
            props.setAttributes({ nav_pos: value });
          },
      ...
      attrs.show_nav &&
        ...
        el(SelectControl, {
          ...
          options: [
            { label: __("Default", "porto-functionality"), value: "" },
            {
              label: __("Inside", "porto-functionality"),
              value: "nav-pos-inside",
            },
            {
              label: __("Outside", "porto-functionality"),
              value: "nav-pos-outside",
            },
          ],
          onChange: (value) => {
            props.setAttributes({ nav_pos2: value });
          },
        }),
      attrs.show_nav &&
        ("" == attrs.nav_pos ||
          "nav-bottom" == attrs.nav_pos ||
          "nav-center-images-only" == attrs.nav_pos) &&
        el(SelectControl, {
          label: __("Nav Type", "porto-functionality"),
          value: attrs.nav_type,
      ...
      attrs.show_dots &&
        el(SelectControl, {
          ...
          options: [
            { label: __("Outside", "porto-functionality"), value: "" },
            { label: __("Inside", "porto-functionality"), value: "nav-inside" },
            {
              label: __("Besides Title", "porto-functionality"),
              value: "show-dots-title",
            },
      ...
      attrs.show_dots &&
        "nav-inside" == attrs.dots_pos &&
        el(SelectControl, {
          label: __("Dots Align", "porto-functionality"),
          value: attrs.dots_align,
          options: [
            { label: __("Right", "porto-functionality"), value: "" },
            {
              label: __("Center", "porto-functionality"),
              value: "nav-inside-center",
            },
            {
              label: __("Left", "porto-functionality"),
              value: "nav-inside-left",
            },
          ],
          onChange: (value) => {
            props.setAttributes({ dots_align: value });
          },
        }),
      attrs.show_dots &&
        el(SelectControl, {
          ...
          options: [
            { label: __("Default", "porto-functionality"), value: "" },
            {
              label: __("Circle inner dot", "porto-functionality"),
              value: "dots-style-1",
            },
          ],
          onChange: (value) => {
            props.setAttributes({ dots_style: value });
          },
        }),
      el(TextControl, {
        ...
        onChange: (value) => {
          props.setAttributes({ animate_in: value });
        },
        help: __(
          "Please check this url to see animation types.",
          "porto-functionality"
      ...
      el(TextControl, {
        ...
        onChange: (value) => {
          props.setAttributes({ animate_out: value });
        },
      }),
      el(
        "p",
      ...
      el(ToggleControl, {
        ...
        onChange: (value) => {
          props.setAttributes({ fullscreen: value });
        },
      }),
      el(ToggleControl, {
      ...
      el(ToggleControl, {
        ...
        checked: attrs.video,
        onChange: (value) => {
          props.setAttributes({ video: value });
        },
      }),
      el(ToggleControl, {
        ...
        onChange: (value) => {
          props.setAttributes({ lazyload: value });
        },
      }),
      el(ToggleControl, {
        ...
        checked: attrs.merge,
        onChange: (value) => {
          props.setAttributes({ merge: value });
        },
      }),
      attrs.merge &&
        el(ToggleControl, {
          ...
          onChange: (value) => {
            props.setAttributes({ mergeFit: value });
          },
        }),
      attrs.merge &&
        el(ToggleControl, {
          ...
          onChange: (value) => {
            props.setAttributes({ mergeFit_lg: value });
          },
        }),
      attrs.merge &&
        el(ToggleControl, {
          ...
          onChange: (value) => {
            props.setAttributes({ mergeFit_md: value });
          },
        }),
      attrs.merge &&
        el(ToggleControl, {
          ...
          onChange: (value) => {
            props.setAttributes({ mergeFit_sm: value });
          },
        }),
      attrs.merge &&
        el(ToggleControl, {
          ...
          onChange: (value) => {
            props.setAttributes({ mergeFit_xs: value });
          },
        }),
    ...
    edit: withSelect(function (select, props) {
      ...
      var inspectorControls = el(
        ...
        el(SelectControl, {
          ...
          options: [
            { label: __("Full", "porto-functionality"), value: "full" },
            { label: __("Large", "porto-functionality"), value: "large" },
            {
              label: __("Large Alt", "porto-functionality"),
              value: "large-alt",
            },
            { label: __("Medium", "porto-functionality"), value: "medium" },
            {
              label: __("Medium Alt", "porto-functionality"),
              value: "medium-alt",
            },
            { label: __("Grid", "porto-functionality"), value: "grid" },
            { label: __("Timeline", "porto-functionality"), value: "timeline" },
            { label: __("Slider", "porto-functionality"), value: "slider" },
          ],
          onChange: (value) => {
            props.setAttributes({ post_layout: value });
          },
        }),
        (post_layout == "grid" ||
          post_layout == "masonry" ||
          ...
          el(SelectControl, {
            ...
            options: [
              { label: __("Default", "porto-functionality"), value: "default" },
              {
                label: __("Default - Date on Image", "porto-functionality"),
                value: "date",
              },
              {
                label: __("Default - Author Picture", "porto-functionality"),
                value: "author",
              },
              {
                label: __("Post Carousel Style", "porto-functionality"),
                value: "related",
              },
              {
                label: __("Hover Info", "porto-functionality"),
                value: "hover_info",
              },
              {
                label: __("No Margin & Hover Info", "porto-functionality"),
                value: "no_margin",
              },
              {
                label: __("With Borders", "porto-functionality"),
                value: "padding",
              },
              { label: __("Modern", "porto-functionality"), value: "modern" },
            ],
            onChange: (value) => {
              props.setAttributes({ post_style: value });
            },
          }),
        (post_layout == "grid" || post_layout == "masonry") &&
          el(RangeControl, {
        ...
        el(TextControl, {
          ...
          value: attrs.post_in,
          onChange: (value) => {
            props.setAttributes({ post_in: value });
          },
        }),
        el(SelectControl, {
          ...
          options: [
            { label: __("No Pagination", "porto-functionality"), value: "" },
            {
              label: __("Show Pagination", "porto-functionality"),
              value: "show",
            },
            {
              label: __("Show Blog Page Link", "porto-functionality"),
              value: "link",
            },
          ],
          onChange: (value) => {
            props.setAttributes({ view_more: value });
          },
        }),
        attrs.view_more == "link" &&
          el(TextControl, {
            label: __(
              "Extra class name for Archive Link",
              "porto-functionality"
            ),
            value: attrs.view_more_class,
            onChange: (value) => {
              props.setAttributes({ view_more_class: value });
            },
          }),
        (post_layout === "grid" ||
          post_layout === "masonry" ||
      ...
      if (
        attrs.post_layout == "full" ||
        attrs.post_layout == "large" ||
        attrs.post_layout == "large-alt"
      ) {
        imageSize = "landsacpe";
        columns = 1;
      ...
      postsRender = props.recentPosts.map(function (post, index) {
        ...
        return el(
          "article",
          {
            className:
              postCls +
              ("timeline" === attrs.post_layout
                ? index % 2
                  ? " right"
                  : " left"
                : ""),
          },
          "large-alt" === attrs.post_layout &&
            el(
              "div",
              { className: "post-date" },
              el(
          ...
          featuredImageSrc &&
            el(
              ...
              "medium-alt" === attrs.post_layout &&
                el(
                  "div",
                  {
                    className:
                      "blog-post-date background-color-primary text-color-light font-weight-bold",
                  },
                  moment(post.date_gmt).local().format("DD"),
                  el(
                    "span",
          ...
          ("full" === attrs.post_layout || "large" === attrs.post_layout) &&
            el(
              "div",
              { className: "post-date" },
              el(
          ...
          el(
            ...
            el("h4", { className: "entry-title" }, post.title.rendered),
            el("p", {
              className: "post-excerpt",
          ...
          el(
            ...
            "medium" === attrs.post_layout &&
              el(
                "a",
                {
                  className: "btn read-more d-block float-sm-end",
                  href: post.link,
                },
                el("span", null, __("Read More", "porto-functionality"))
              )
          ),
          "medium" !== attrs.post_layout &&
            "medium-alt" !== attrs.post_layout &&
          ...
          "medium-alt" === attrs.post_layout &&
            el(
              ...
              {
                className:
                  "btn btn-lg d-inline-block btn-borders btn-primary custom-border-radius font-weight-semibold text-uppercase m-t-md",
              },
              el("span", null, __("Read More", "porto-functionality"))
            )
        );
      ...
      if (attrs.post_layout == "timeline") {
        renderControls = el(
          ...
          {
            className:
              "porto-blog" + (attrs.className ? " " + attrs.className : ""),
          },
          widgetTitle && el("h4", {}, widgetTitle),
          el(
            "div",
            {
              className:
                "blog-posts posts-" +
                attrs.post_layout +
                (attrs.post_style ? " blog-posts-" + attrs.post_style : ""),
            },
            el(
              "section",
              { className: "timeline" },
              el("div", { className: "timeline-body" }, postsRender)
            )
          ),
          paginationRender
        );
      } else if (
        attrs.post_layout == "grid" ||
        attrs.post_layout == "masonry"
      ) {
        renderControls = el(
          "div",
          {
          ...
          el(
            "div",
            {
              className:
                "blog-posts posts-" +
                attrs.post_layout +
                (columns > 1 ? " posts-container columns-" + columns : ""),
            },
            postsRender
          ),
          paginationRender
...
(function (
  ...
  class PortoMap extends Component {
    ...
    componentDidUpdate(prevProps, prevState) {
      ...
      if (prevState !== this.state) return null;
    ...
    initMap() {
      ...
      mapObj = new google.maps.Map(
        window.portoBlockDocument().getElementById(mapId),
        mapOptions
      );
    ...
    render() {
      ...
      var inspectorControls = el(
        ...
        el(SelectControl, {
          ...
          options: [
            { label: __("Roadmap", "porto-functionality"), value: "ROADMAP" },
            {
              label: __("Satellite", "porto-functionality"),
              value: "SATELLITE",
            },
            { label: __("Hybrid", "porto-functionality"), value: "HYBRID" },
            { label: __("Terrain", "porto-functionality"), value: "TERRAIN" },
          ],
          onChange: (value) => {
            props.setAttributes({ map_type: value });
          },
        }),
        el(TextControl, {
        ...
        el(
          ...
          " " +
            __(
              "where you can find Latitude & Longitude of your location",
              "porto-functionality"
            )
        ),
        el(RangeControl, {
        ...
        el(ToggleControl, {
          label: __(
            "Disable map zoom on mouse wheel scroll",
            "porto-functionality"
          ),
        ...
        el(SelectControl, {
          ...
          options: [
            { label: __("Yes", "porto-functionality"), value: "on" },
            { label: __("No", "porto-functionality"), value: "off" },
          ],
          onChange: (value) => {
            props.setAttributes({ infowindow_open: value });
          },
        }),
        el(SelectControl, {
          ...
          options: [
            {
              label: __("Use Google Default", "porto-functionality"),
              value: "default",
            },
            {
              label: __("Upload Custom", "porto-functionality"),
              value: "custom",
            },
          ],
          onChange: (value) => {
            props.setAttributes({ marker_icon: value });
          },
        }),
        "custom" == attrs.marker_icon &&
          el(MediaUpload, {
            allowedTypes: ["image"],
            value: attrs.icon_img,
            onSelect: function onSelect(image) {
              return props.setAttributes({
                icon_img_url: image.url,
                icon_img: image.id,
              });
            },
        ...
        el(SelectControl, {
          ...
          options: [
            { label: __("Disable", "porto-functionality"), value: "false" },
            { label: __("Enable", "porto-functionality"), value: "true" },
          ],
          onChange: (value) => {
            props.setAttributes({ streetviewcontrol: value });
          },
        }),
        el(SelectControl, {
          ...
          onChange: (value) => {
            props.setAttributes({ maptypecontrol: value });
          },
        }),
        el(SelectControl, {
          ...
          onChange: (value) => {
            props.setAttributes({ zoomcontrol: value });
          },
        }),
        "true" == attrs.zoomcontrol &&
          el(SelectControl, {
            label: __("Zoom Control Position", "porto-functionality"),
            value: attrs.zoomcontrolposition,
            options: [
              {
                label: __("Right Bottom", "porto-functionality"),
                value: "RIGHT_BOTTOM",
              },
              {
                label: __("Right Top", "porto-functionality"),
                value: "RIGHT_TOP",
              },
              {
                label: __("Right Center", "porto-functionality"),
                value: "RIGHT_CENTER",
              },
              {
                label: __("Left Top", "porto-functionality"),
                value: "LEFT_TOP",
              },
              {
                label: __("Left Center", "porto-functionality"),
                value: "LEFT_CENTER",
              },
              {
                label: __("Left Bottom", "porto-functionality"),
                value: "LEFT_BOTTOM",
              },
            ],
            onChange: (value) => {
              props.setAttributes({ zoomcontrolposition: value });
            },
          }),
        el(SelectControl, {
          ...
          onChange: (value) => {
            props.setAttributes({ dragging: value });
          },
        }),
        el(SelectControl, {
          ...
          options: [
            {
              label: __("Page (small)", "porto-functionality"),
              value: "page_margin_top",
            },
            {
              label: __("Section (large)", "porto-functionality"),
              value: "page_margin_top_section",
            },
            { label: __("None", "porto-functionality"), value: "none" },
          ],
          onChange: (value) => {
            props.setAttributes({ top_margin: value });
          },
        }),
        el(SelectControl, {
          ...
          options: [
            { label: __("Default Width", "porto-functionality"), value: "0" },
            { label: __("Apply 1st parent element's width"), value: "1" },
            { label: __("Apply 2nd parent element's width"), value: "2" },
            { label: __("Apply 3rd parent element's width"), value: "3" },
            { label: __("Apply 4th parent element's width"), value: "4" },
            { label: __("Apply 5th parent element's width"), value: "5" },
            { label: __("Apply 6th parent element's width"), value: "6" },
            { label: __("Apply 7th parent element's width"), value: "7" },
            { label: __("Apply 8th parent element's width"), value: "8" },
            { label: __("Apply 9th parent element's width"), value: "9" },
            { label: __("Full Width", "porto-functionality"), value: "full" },
            {
              label: __("Maximum Full Width", "porto-functionality"),
              value: "ex-full",
            },
          ],
          onChange: (value) => {
            props.setAttributes({ map_override: value });
          },
        }),
        el(
          "p",
        ...
        el(TextareaControl, {
          ...
          onChange: (value) => {
            props.setAttributes({ map_style: value });
          },
        }),
        el(
          "p",
          ...
          el(
            ...
            {
              target: "_blank",
              href: "http://googlemaps.github.io/js-samples/styledmaps/wizard/index.html",
            },
            __("Click here", "porto-functionality")
          ),
          " " +
            __(
              "to get the style JSON code for styling your map.",
              "porto-functionality"
            )
        )
      );
...
(function (
  ...
  const PortoUltimateHeading = function (props) {
    ...
    var inspectorControls = el(
      ...
      el(
        ...
        el(SelectControl, {
          ...
          options: [
            { label: __("H1", "porto-functionality"), value: "h1" },
            { label: __("H2", "porto-functionality"), value: "h2" },
            { label: __("H3", "porto-functionality"), value: "h3" },
            { label: __("H4", "porto-functionality"), value: "h4" },
            { label: __("H5", "porto-functionality"), value: "h5" },
            { label: __("H6", "porto-functionality"), value: "h6" },
          ],
          onChange: (value) => {
            props.setAttributes({ heading_tag: value });
          },
        }),
        el(SelectControl, {
          ...
          options: [
            {
              label: __("No Separator", "porto-functionality"),
              value: "no_spacer",
            },
            { label: __("Line", "porto-functionality"), value: "line_only" },
          ],
          onChange: (value) => {
            props.setAttributes({ spacer: value });
          },
        }),
        el(
          "p",
          { style: { fontStyle: "italic" } },
          __(
            "Horizontal line, icon or image to divide sections",
            "porto-functionality"
          )
        ),
        attrs.spacer == "line_only" &&
          el(SelectControl, {
            label: __("Separator Position", "porto-functionality"),
            value: attrs.spacer_position,
            options: [
              { label: __("Top", "porto-functionality"), value: "top" },
              {
                label: __(
                  "Between Heading & Sub-Heading",
                  "porto-functionality"
                ),
                value: "middle",
              },
              { label: __("Bottom", "porto-functionality"), value: "bottom" },
            ],
            onChange: (value) => {
              props.setAttributes({ spacer_position: value });
            },
          }),
        attrs.spacer == "line_only" &&
          el(RangeControl, {
            ...
            max: 500,
            onChange: (value) => {
              props.setAttributes({ line_width: value });
            },
          }),
        attrs.spacer == "line_only" &&
          el(RangeControl, {
            ...
            max: 100,
            onChange: (value) => {
              props.setAttributes({ line_height: value });
            },
          }),
        attrs.spacer == "line_only" &&
      ...
      el(
        ...
        el(PortoTypographyControl, {
          ...
          value: {
            fontFamily: attrs.main_heading_font_family,
            fontSize: attrs.main_heading_font_size,
            fontWeight: attrs.main_heading_font_weight,
            textTransform: attrs.main_heading_text_transform,
            lineHeight: attrs.main_heading_line_height,
            letterSpacing: attrs.main_heading_letter_spacing,
            color: attrs.main_heading_color,
          },
          options: { textAlign: false },
          onChange: (value) => {
            if (typeof value.fontFamily != "undefined") {
              props.setAttributes({
                main_heading_font_family: value.fontFamily,
              });
            }
            ...
            if (typeof value.fontWeight != "undefined") {
              props.setAttributes({
                main_heading_font_weight: value.fontWeight,
              });
            }
            if (typeof value.textTransform != "undefined") {
              props.setAttributes({
                main_heading_text_transform: value.textTransform,
              });
            }
            if (typeof value.lineHeight != "undefined") {
              props.setAttributes({
                main_heading_line_height: value.lineHeight,
              });
            }
            if (typeof value.letterSpacing != "undefined") {
              props.setAttributes({
                main_heading_letter_spacing: value.letterSpacing,
              });
            }
        ...
        el(RangeControl, {
          ...
          max: 100,
          onChange: (value) => {
            props.setAttributes({ main_heading_margin_bottom: value });
          },
        }),
        ...
        el(PortoTypographyControl, {
          ...
          value: {
            fontFamily: attrs.sub_heading_font_family,
            fontSize: attrs.sub_heading_font_size,
            fontWeight: attrs.sub_heading_font_weight,
            lineHeight: attrs.sub_heading_line_height,
            letterSpacing: attrs.sub_heading_letter_spacing,
            color: attrs.sub_heading_color,
          },
          options: { textTransform: false, textAlign: false },
          onChange: (value) => {
            if (typeof value.fontFamily != "undefined") {
              props.setAttributes({
                sub_heading_font_family: value.fontFamily,
              });
            }
            if (typeof value.fontSize != "undefined") {
            ...
            if (typeof value.fontWeight != "undefined") {
              props.setAttributes({
                sub_heading_font_weight: value.fontWeight,
              });
            }
            if (typeof value.lineHeight != "undefined") {
              props.setAttributes({
                sub_heading_line_height: value.lineHeight,
              });
            }
            if (typeof value.letterSpacing != "undefined") {
              props.setAttributes({
                sub_heading_letter_spacing: value.letterSpacing,
              });
            }
            if (typeof value.color != "undefined") {
        ...
        el(RangeControl, {
          ...
          max: 100,
          onChange: (value) => {
            props.setAttributes({ sub_heading_margin_bottom: value });
          },
        }),
        el(SelectControl, {
          ...
          options: [
            { label: __("Default", "porto-functionality"), value: "" },
            { label: __("Inherit", "porto-functionality"), value: "inherit" },
            { label: __("Left", "porto-functionality"), value: "left" },
            { label: __("Center", "porto-functionality"), value: "center" },
            { label: __("Right", "porto-functionality"), value: "right" },
            { label: __("Justify", "porto-functionality"), value: "justify" },
          ],
          onChange: (value) => {
        ...
        attrs.spacer == "line_only" &&
          el(RangeControl, {
            ...
            max: 50,
            onChange: (value) => {
              props.setAttributes({ spacer_margin_bottom: value });
            },
          }),
        el(TextControl, {
          label: __("Animation Type", "porto-functionality"),
    ...
    if (attrs.main_heading_margin_bottom) {
      main_heading_style_inline.marginBottom =
        attrs.main_heading_margin_bottom + "px";
    }
    ...
    if (attrs.main_heading_letter_spacing) {
      ...
      main_heading_style_inline.letterSpacing =
        attrs.main_heading_letter_spacing;
    }
    if (attrs.main_heading_text_transform) {
      main_heading_style_inline.textTransform =
        attrs.main_heading_text_transform;
    }
    ...
    if (attrs.sub_heading_margin_bottom) {
      sub_heading_style_inline.marginBottom =
        attrs.sub_heading_margin_bottom + "px";
    }
    ...
    if ("line_only" == attrs.spacer) {
      ...
      line_style_inline.width =
        attrs.line_width + ("auto" == attrs.line_width ? "" : "px");
      line_style_inline.float = attrs.alignment;
      wrapper_style.height = attrs.line_height + "px";
      icon_inline = el("span", {
        className: "porto-u-headings-line",
        style: line_style_inline,
      });
    }
    ...
    if (attrs.spacer) {
      spacerRender = el(
        "div",
        {
          className: "porto-u-heading-spacer " + attrs.spacer,
          style: wrapper_style,
        },
        icon_inline
      );
    ...
    var renderControls = el(
      ...
      {
        className:
          "porto-u-heading" + (attrs.className ? " " + attrs.className : ""),
      ...
      attrs.content &&
        el("div", {
          className: "porto-u-sub-heading",
          style: sub_heading_style_inline,
          dangerouslySetInnerHTML: {
            __html: attrs.content.replace(/<script.*?\/script>/g, ""),
          },
        }),
  ...
  registerBlockType("porto/porto-ultimate-heading", {
    ...
    description: __(
      "Display the heading with description.",
      "porto-functionality"
    ),
    attributes: {
      main_heading: {
...
(function (
  ...
  const PortoInfoBox = function (props) {
    ...
    var inspectorControls = el(
      ...
      el(
        ...
        el(SelectControl, {
          ...
          options: [
            {
              label: __("Icon at Left with heading", "porto-functionality"),
              value: "default",
            },
            {
              label: __("Icon at Right with heading", "porto-functionality"),
              value: "heading-right",
            },
            { label: __("Icon at Left", "porto-functionality"), value: "left" },
            {
              label: __("Icon at Right", "porto-functionality"),
              value: "right",
            },
            { label: __("Icon at Top", "porto-functionality"), value: "top" },
          ],
          onChange: (value) => {
            props.setAttributes({ pos: value });
          },
        }),
        "top" === attrs.pos &&
          el(SelectControl, {
            ...
            onChange: (value) => {
              props.setAttributes({ h_align: value });
            },
          }),
        el(SelectControl, {
          ...
          options: [
            { label: __("Icon Font", "porto-functionality"), value: "" },
            {
              label: __("Custom Image Icon", "porto-functionality"),
              value: "custom",
            },
          ],
          onChange: (value) => {
            props.setAttributes({ icon_type: value });
          },
        }),
        !attrs.icon_type &&
          el(TextControl, {
            ...
            help: __(
              "Please check this url to see icons which Porto supports. ",
              "porto-functionality"
            ),
          }),
        !attrs.icon_type &&
        ...
        "custom" == attrs.icon_type &&
          el(RangeControl, {
            ...
            max: 512,
            onChange: (value) => {
              props.setAttributes({ img_width: value });
            },
          }),
        "custom" != attrs.icon_type &&
          el(RangeControl, {
        ...
        el(SelectControl, {
          ...
          options: [
            { label: __("Simple", "porto-functionality"), value: "none" },
            {
              label: __("Circle Background", "porto-functionality"),
              value: "circle",
            },
            {
              label: __("Circle Image", "porto-functionality"),
              value: "circle_img",
            },
            {
              label: __("Square Background", "porto-functionality"),
              value: "square",
            },
            {
              label: __("Design your own", "porto-functionality"),
              value: "advanced",
            },
          ],
          onChange: (value) => {
        ...
        ("circle_img" == attrs.icon_style || "advanced" == attrs.icon_style) &&
          el(SelectControl, {
            label: __("Icon Border Style", "porto-functionality"),
            value: attrs.icon_border_style,
            options: [
              { label: __("None", "porto-functionality"), value: "" },
              { label: __("Solid", "porto-functionality"), value: "solid" },
              { label: __("Dashed", "porto-functionality"), value: "dashed" },
              { label: __("Dotted", "porto-functionality"), value: "dotted" },
              { label: __("Double", "porto-functionality"), value: "double" },
              { label: __("Inset", "porto-functionality"), value: "inset" },
              { label: __("Outset", "porto-functionality"), value: "outset" },
            ],
            onChange: (value) => {
              props.setAttributes({ icon_border_style: value });
            },
          }),
        ...
        attrs.icon_border_style &&
          el(RangeControl, {
            ...
            max: 10,
            onChange: (value) => {
              props.setAttributes({ icon_border_size: value });
            },
          }),
        attrs.icon_border_style &&
          el(RangeControl, {
            ...
            max: 500,
            onChange: (value) => {
              props.setAttributes({ icon_border_radius: value });
            },
          }),
        ("circle_img" == attrs.icon_style || "advanced" == attrs.icon_style) &&
          el(RangeControl, {
            ...
            max: 500,
            onChange: (value) => {
              props.setAttributes({ icon_border_spacing: value });
            },
          }),
        ("circle_img" == attrs.icon_style || "advanced" == attrs.icon_style) &&
          el(
            ...
            { style: { fontStyle: "italic" } },
            __(
              "Spacing from center of the icon till the boundary of border / background",
              "porto-functionality"
            )
          ),
        el(TextControl, {
        ...
        el(SelectControl, {
          ...
          options: [
            { label: __("No Link", "porto-functionality"), value: "none" },
            { label: __("Complete Box", "porto-functionality"), value: "box" },
            { label: __("Box Title", "porto-functionality"), value: "title" },
            {
              label: __("Display Read More", "porto-functionality"),
              value: "more",
            },
          ],
          onChange: (value) => {
            props.setAttributes({ read_more: value });
          },
        }),
        "none" != attrs.read_more &&
          el(TextControl, {
        ...
        el(SelectControl, {
          ...
          options: [
            { label: __("No Effect", "porto-functionality"), value: "style_1" },
            { label: __("Icon Zoom", "porto-functionality"), value: "style_2" },
            {
              label: __("Icon Bounce Up", "porto-functionality"),
              value: "style_3",
            },
          ],
          onChange: (value) => {
            props.setAttributes({ hover_effect: value });
          },
        }),
        ...
        el(SelectControl, {
          ...
          options: [
            ...
            { label: __("H5", "porto-functionality"), value: "h5" },
            { label: __("H6", "porto-functionality"), value: "h6" },
            { label: __("div", "porto-functionality"), value: "div" },
            { label: __("p", "porto-functionality"), value: "p" },
          ],
          onChange: (value) => {
            props.setAttributes({ heading_tag: value });
          },
      ...
      el(
        ...
        el(TextControl, {
          ...
          help: __(
            "Enter value including any valid CSS unit, ex: 30px.",
            "porto-functionality"
          ),
          onChange: (value) => {
            props.setAttributes({ icon_margin_right: value });
          },
        }),
        el(TextControl, {
          ...
          onChange: (value) => {
            props.setAttributes({ icon_margin_bottom: value });
          },
        }),
        el(TextControl, {
          ...
          onChange: (value) => {
            props.setAttributes({ title_margin_bottom: value });
          },
        }),
        el(TextControl, {
          ...
          onChange: (value) => {
            props.setAttributes({ sub_title_margin_bottom: value });
          },
        }),
        el(PortoTypographyControl, {
          label: __("Title Font", "porto-functionality"),
          value: {
            fontFamily: attrs.title_font,
            fontSize: attrs.title_font_size,
            fontWeight: attrs.title_font_style,
            textTransform: attrs.title_text_transform,
            lineHeight: attrs.title_font_line_height,
            letterSpacing: attrs.title_font_letter_spacing,
            color: attrs.title_font_color,
          },
          options: {},
          onChange: (value) => {
            if (typeof value.fontFamily != "undefined") {
            ...
            if (typeof value.textTransform != "undefined") {
              props.setAttributes({
                title_text_transform: value.textTransform,
              });
            }
            if (typeof value.lineHeight != "undefined") {
            ...
            if (typeof value.letterSpacing != "undefined") {
              props.setAttributes({
                title_font_letter_spacing: value.letterSpacing,
              });
            }
            if (typeof value.color != "undefined") {
        ...
        el(PortoTypographyControl, {
          ...
          value: {
            fontSize: attrs.subtitle_font_size,
            fontWeight: attrs.subtitle_font_style,
            lineHeight: attrs.subtitle_font_line_height,
            letterSpacing: attrs.subtitle_font_letter_spacing,
            color: attrs.subtitle_font_color,
          },
          ...
          onChange: (value) => {
            ...
            if (typeof value.lineHeight != "undefined") {
              props.setAttributes({
                subtitle_font_line_height: value.lineHeight,
              });
            }
            if (typeof value.letterSpacing != "undefined") {
              props.setAttributes({
                subtitle_font_letter_spacing: value.letterSpacing,
              });
            }
            if (typeof value.color != "undefined") {
        ...
        el(PortoTypographyControl, {
          ...
          value: {
            fontFamily: attrs.desc_font,
            fontSize: attrs.desc_font_size,
            fontWeight: attrs.desc_font_style,
            lineHeight: attrs.desc_font_line_height,
            letterSpacing: attrs.desc_font_letter_spacing,
            color: attrs.desc_font_color,
          },
          ...
          onChange: (value) => {
            ...
            if (typeof value.letterSpacing != "undefined") {
              props.setAttributes({
                desc_font_letter_spacing: value.letterSpacing,
              });
            }
            if (typeof value.color != "undefined") {
    ...
    if (attrs.subtitle_font_line_height) {
      const unit = ("" + attrs.subtitle_font_line_height).replace(
        /[0-9.]/g,
        ""
      );
    ...
    if (
      attrs.sub_title_margin_bottom ||
      "0" === attrs.sub_title_margin_bottom
    ) {
    ...
    if (attrs.icon_type == "custom") {
      ...
      if (
        (attrs.icon_style == "advanced" || attrs.icon_style == "circle_img") &&
        attrs.icon_border_style
      ) {
      ...
      if (attrs.icon) {
        ...
        boxIcon = el(
          "div",
          {
            className: "porto-icon " + attrs.icon_style + " " + elx_class,
            style: boxIconStyle,
          },
    ...
    var internal_style = "";
    if (
      attrs.icon_style == "circle_img" &&
      attrs.icon_type == "custom" &&
      attrs.icon_border_spacing
    ) {
      internal_style +=
        "#porto-icon-" +
        clientId +
      ...
      internal_style +=
        "border-width: " + (attrs.icon_border_spacing + 1) + "px";
      if (attrs.icon_color_bg) {
        internal_style += "border-color: " + attrs.icon_color_bg;
      }
      internal_style += "}";
      internal_style = el("style", null, internal_style);
    }
    boxIcon = el(
      "div",
    ...
    if (attrs.pos == "heading-right" || attrs.pos == "right") {
      if (attrs.title) {
        var titleRender = el(attrs.heading_tag, {
          className: "porto-sicon-title",
          style: title_style,
          dangerouslySetInnerHTML: {
            __html: attrs.title.replace(/<script.*?\/script>/g, ""),
          },
        });
        bodyRender = el(
          "div",
          ...
          attrs.subtitle && el("p", { style: subtitle_style }, attrs.subtitle)
        );
      }
      bodyRender = el(
        "div",
        {
          className:
            attrs.pos == "right"
              ? "porto-sicon-body"
              : "porto-sicon-box" + (ex_class ? " " + ex_class : ""),
        },
        bodyRender,
        attrs.pos != "right" &&
          (attrs.icon || attrs.icon_img_url) &&
          el("div", { className: ic_class }, boxIcon),
        attrs.content &&
          el(
            "div",
            {
              className: "porto-sicon-description",
              style: desc_style,
              dangerouslySetInnerHTML: {
                __html: attrs.content.replace(/<script.*?\/script>/g, ""),
              },
      ...
      var titleRender = "",
        contentRender = "";
      if (attrs.title) {
        titleRender = el(attrs.heading_tag, {
          className: "porto-sicon-title",
          style: title_style,
          dangerouslySetInnerHTML: {
            __html: attrs.title.replace(/<script.*?\/script>/g, ""),
  ...
  const PortoStatCounter = function (props) {
    useEffect(() => {
      ...
      counterWillUpdate = setTimeout(function () {
        jQuery(window.portoBlockDocument().body).trigger(
          "porto_refresh_vc_content",
          [jQuery('[data-block="' + clientId + '"]')]
        );
      }, 1000);
    }, [
      props.attributes.counter_title,
      props.attributes.counter_value,
      props.attributes.counter_sep,
      props.attributes.counter_suffix,
      props.attributes.counter_prefix,
      props.attributes.counter_decimal,
      props.attributes.speed,
    ]);

    if (isFirstLoad && typeof countUp == "undefined") {
      isFirstLoad = false;
      var c = window.portoBlockDocument().createElement("script");
      c.src = ajaxurl.replace(
    ...
    var inspectorControls = el(
      ...
      el(
        ...
        el(SelectControl, {
          ...
          onChange: (value) => {
            props.setAttributes({ icon_position: value });
          },
        }),
        el(TextControl, {
          ...
          onChange: (value) => {
            props.setAttributes({ counter_title: value });
          },
        }),
        el(TextControl, {
          ...
          onChange: (value) => {
            props.setAttributes({ counter_value: value });
          },
        }),
        el(TextControl, {
          ...
          onChange: (value) => {
            props.setAttributes({ counter_sep: value });
          },
        }),
        el(TextControl, {
          ...
          onChange: (value) => {
            props.setAttributes({ counter_decimal: value });
          },
        }),
        el(TextControl, {
          ...
          onChange: (value) => {
            props.setAttributes({ counter_prefix: value });
          },
        }),
        el(TextControl, {
          ...
          onChange: (value) => {
            props.setAttributes({ counter_suffix: value });
          },
        }),
        el(RangeControl, {
      ...
      el(
        ...
        el(PortoTypographyControl, {
          ...
          value: {
            fontFamily: attrs.suf_pref_font,
            fontSize: attrs.suf_pref_font_size,
            fontWeight: attrs.suf_pref_font_style,
            lineHeight: attrs.suf_pref_line_height,
            color: attrs.suf_pref_font_color,
          },
          options: { textTransform: false, letterSpacing: false },
          onChange: (value) => {
            if (typeof value.fontFamily != "undefined") {
    ...
    if (attrs.desc_font_color || attrs.counter_color_txt) {
      desc_style.color = attrs.desc_font_color
        ? attrs.desc_font_color
        : attrs.counter_color_txt;
    }
    ...
    var renderControls = el(
      ...
      attrs.icon_position != "right" &&
        el("div", { className: "porto-sicon-" + attrs.icon_position }, boxIcon),
      el(
        "div",
        ...
        el(
          "div",
          {
            id: "counter_" + clientId,
            "data-id": "counter_" + clientId,
            className: "stats-number",
            style: desc_style,
            "data-speed": attrs.speed,
            "data-counter-value": attrs.counter_value,
            "data-separator": attrs.counter_sep,
            "data-decimal": attrs.counter_decimal,
          },
          "0"
        ),
...
(function (
  ...
  const PortoIcons = function (props) {
    ...
    var inspectorControls = el(
      ...
      el(SelectControl, {
        ...
        help: __(
          "Select the type of effct you want on hover",
          "porto-functionality"
        ),
        value: attrs.hover_effect,
        options: [
          { label: __("No Effect", "porto-functionality"), value: "" },
          {
            label: __("Icon Zoom", "porto-functionality"),
            value: "hover-icon-zoom",
          },
          {
            label: __("Icon Slide Up", "porto-functionality"),
            value: "hover-icon-up",
          },
          {
            label: __("Icon Slide Left", "porto-functionality"),
            value: "hover-icon-left",
          },
          {
            label: __("Icon Slide Right", "porto-functionality"),
            value: "hover-icon-right",
          },
          {
            label: __("Icon Slide Right & Left", "porto-functionality"),
            value: "hover-icon-pulse-left-right",
          },
          {
            label: __("Icon Slide Infinite", "porto-functionality"),
            value: "hover-icon-pulse-infnite",
          },
        ],
        onChange: (value) => {
          props.setAttributes({ hover_effect: value });
    ...
    return [
      el(
        ...
        el(BlockAlignmentToolbar, {
          value: attrs.align
            ? attrs.align.replace("porto-icons-", "")
            : attrs.align,
          onChange: function onChange(value) {
  ...
  registerBlockType("porto/porto-icons", {
    ...
    category: "porto",
    description: __(
      "Add a set of multiple icons and give some custom style.",
      "porto-functionality"
    ),
    attributes: {
      align: { type: "string" },
...
(function (
  ...
  const PortoSingleIcon = function (props) {
    ...
    var inspectorControls = el(
      ...
      el(
        ...
        el(
          ...
          el(RangeControl, {
            ...
            max: 100,
            onChange: (value) => {
              props.setAttributes({ icon_margin: value });
            },
          }),
          el(PanelColorSettings, {
          ...
          el(SelectControl, {
            ...
            options: [
              { label: __("Custom Link", "porto-functionality"), value: "" },
              {
                label: __("Dymamic Link", "porto-functionality"),
                value: "dynamic",
              },
            ],
            onChange: (value) => {
              props.setAttributes({ link_source: value });
            },
          }),
          "dynamic" === attrs.link_source &&
            el(PortoDynamicContentControl, {
              ...
              options: {
                field_type: "link",
                content_type:
                  typeof porto_content_type == "undefined"
                    ? false
                    : porto_content_type,
                content_type_value:
                  typeof porto_content_type_value == "undefined"
                    ? ""
                    : porto_content_type_value,
              },
              onChange: (value) => {
                props.setAttributes({ link_dynamic_content: value });
              },
            }),
          !attrs.link_source &&
            el(TextControl, {
              ...
              onChange: (value) => {
                props.setAttributes({ icon_link: value });
              },
            }),
          el(TextControl, {
            label: __("Animation Type", "porto-functionality"),
      ...
      el(
        ...
        el(PortoStyleOptionsControl, {
          ...
          options: {},
          onChange: (value) => {
            props.setAttributes({ style_options: value });
          },
        })
      )
    );
    ...
    var renderControls = el(
      "div",
      {
        className:
          "porto-icon " +
          selectorCls +
          (attrs.icon_style ? " " + attrs.icon_style : "") +
          (attrs.className ? " " + attrs.className : ""),
        style: boxIconStyle,
      },
      el(
    ...
    if (attrs.icon_link) {
      renderControls = el("a", { href: attrs.icon_link }, renderControls);
    }
  ...
  registerBlockType("porto/porto-single-icon", {
    ...
    category: "porto",
    description: __(
      "Add a individual single icon with dynamic link for member or portfolio share links.",
      "porto-functionality"
    ),
    attributes: {
      icon: { type: "string" },
...
(function (
  ...
  const PortoInteractiveBanner = function (props) {
    ...
    useEffect(() => {
        ...
        if (field_name) {
          jQuery.ajax({
            ...
            data: {
              ...
              content_type:
                typeof porto_content_type != "undefined" && porto_content_type
                  ? porto_content_type
                  : "post",
              content_type_value:
                typeof porto_content_type_value != "undefined"
                  ? porto_content_type_value
                  : porto_block_vars.edit_post_id,
      ...
      attrs.img_source,
      attrs.dynamic_content && attrs.dynamic_content.source,
      attrs.dynamic_content && attrs.dynamic_content.post_info,
      attrs.dynamic_content && attrs.dynamic_content.metabox,
      attrs.dynamic_content && attrs.dynamic_content.acf,
      attrs.dynamic_content && attrs.dynamic_content.toolset,
      attrs.dynamic_content && attrs.dynamic_content.meta,
      attrs.dynamic_content && attrs.dynamic_content.tax,
      attrs.dynamic_content && attrs.dynamic_content.woo,
    ]);
      ...
      el(
        ...
        el(
          ...
          el(TextControl, {
            ...
            onChange: (value) => {
              props.setAttributes({ banner_title: value });
            },
          }),
          el(TextareaControl, {
            label: __("Description", "porto-functionality"),
        ...
        el(
          ...
          el(
            ...
            el(SelectControl, {
              ...
              options: [
                { label: __("Custom Image", "porto-functionality"), value: "" },
                {
                  label: __("Dymamic Content", "porto-functionality"),
                  value: "dynamic",
                },
              ],
              onChange: (value) => {
                props.setAttributes({ img_source: value });
              },
            }),
            "dynamic" == attrs.img_source &&
              el(PortoDynamicContentControl, {
                label: __("Dynamic Content", "porto-functionality"),
                ...
                onChange: (value) => {
                  props.setAttributes({ dynamic_content: value });
                },
              }),
            !attrs.img_source &&
              el(
          ...
          attrs.banner_image &&
            el(ToggleControl, {
              ...
              help: __(
                'If you have this element in Porto Carousel, please check "Lazy Load" option in Porto Carousel element.',
                "porto-functionality"
              ),
            }),
          el(ToggleControl, {
            ...
            onChange: (value) => {
              props.setAttributes({ add_container: value });
            },
          }),
          el(TextControl, {
          ...
          el(TextControl, {
            ...
            help: __(
              "Enter parallax speed ratio if you want to use parallax effect. (Note: Default value is 1.5, min value is 1. Leave empty if you don't want.)",
              "porto-functionality"
            ),
          ...
          el(SelectControl, {
            ...
            options: [
              { label: __("None", "porto-functionality"), value: "" },
              {
                label: __("kenBurnsToRight", "porto-functionality"),
                value: "kenBurnsToRight",
              },
              {
                label: __("kenBurnsToLeft", "porto-functionality"),
                value: "kenBurnsToLeft",
              },
              {
                label: __("kenBurnsToLeftTop", "porto-functionality"),
                value: "kenBurnsToLeftTop",
              },
              {
                label: __("kenBurnsToRightTop", "porto-functionality"),
                value: "kenBurnsToRightTop",
              },
            ],
            onChange: (value) => {
              props.setAttributes({ banner_effect: value });
            },
          }),
          "" != attrs.banner_effect &&
            el(RangeControl, {
              ...
              max: 1000,
              onChange: (value) => {
                props.setAttributes({ effect_duration: value });
              },
            }),
          el(SelectControl, {
            ...
            options: [
              { label: __("None", "porto-functionality"), value: "" },
              {
                label: __("Snowfall", "porto-functionality"),
                value: "snowfall",
              },
              { label: __("Sparkle", "porto-functionality"), value: "sparkle" },
            ],
            onChange: (value) => {
              props.setAttributes({ particle_effect: value });
            },
          }),
          el(SelectControl, {
            label: __("Link Source", "porto-functionality"),
          ...
          !attrs.link_source &&
            el(TextControl, {
              ...
              onChange: (value) => {
                props.setAttributes({ banner_link: value });
              },
            }),
          attrs.banner_title &&
            el(RangeControl, {
              ...
              max: 80,
              onChange: (value) => {
                props.setAttributes({ banner_title_font_size: value });
              },
            }),
          el(SelectControl, {
            ...
            options: [
              ...
              {
                label: __("Effect 1", "porto-functionality"),
                value: "effect-1",
              },
              {
                label: __("Effect 2", "porto-functionality"),
                value: "effect-2",
              },
              {
                label: __("Effect 3", "porto-functionality"),
                value: "effect-3",
              },
              {
                label: __("Effect 4", "porto-functionality"),
                value: "effect-4",
              },
            ],
            onChange: (value) => {
              props.setAttributes({ banner_style: value });
            },
          }),
          attrs.banner_title &&
            el(PanelColorSettings, {
          ...
          el(RangeControl, {
            ...
            step: 0.1,
            onChange: (value) => {
              props.setAttributes({ image_opacity: value });
            },
          }),
          el(RangeControl, {
            ...
            step: 0.1,
            onChange: (value) => {
              props.setAttributes({ image_opacity_on_hover: value });
            },
          })
        )
      ),
    ...
    if (
      attrs.image_opacity &&
      attrs.image_opacity != attrs.image_opacity_on_hover &&
      attrs.image_opacity !== 1.0
    ) {
    ...
    if (
      attrs.banner_effect != "" ||
      (attrs.particle_effect == "" && attrs.banner_image_url)
    ) {
    ...
    var wrapperAttrs = {
      className:
        "porto-ibanner " +
        selectorCls +
        (attrs.banner_style ? " porto-ibe-" + attrs.banner_style : "") +
        (attrs.className ? " " + attrs.className : ""),
    ...
    var renderControls = el(
      ...
      (attrs.banner_effect || attrs.particle_effect) &&
        el(
          "div",
          ...
          el(
            "div",
            {
              className: `banner-effect${
                attrs.banner_effect ? " " + attrs.banner_effect : ""
              }`,
              ...backgroundStyle,
            },
            attrs.particle_effect &&
              el("div", {
                className: `particle-effect${
                  attrs.particle_effect ? " " + attrs.particle_effect : ""
                }`,
              })
          )
        ),
      ...
      el(
        ...
        attrs.banner_title &&
          el(
            "h2",
            {
              className: "porto-ibanner-title",
              style: banner_title_style_inline,
            },
            attrs.banner_title
          ),
        attrs.content &&
          el(
            "div",
            {
              className: "porto-ibanner-content",
              style: banner_desc_style_inline,
            },
            attrs.content
          ),
        el(InnerBlocks, {
          allowedBlocks: ["porto/porto-interactive-banner-layer"],
        })
      ),
      attrs.banner_link &&
        el("a", { className: "porto-ibanner-link", href: attrs.banner_link })
    );
...
(function (
  ...
  const PortoInteractiveBannerLayer = function (props) {
    useEffect(() => {
      ...
      props.attributes.horizontal,
      props.attributes.vertical,
    ]);
    ...
    var inspectorControls = el(
      ...
      el(RangeControl, {
        ...
        step: 1,
        onChange: (value) => {
          props.setAttributes({ horizontal: value });
        },
      }),
      el(
        "p",
      ...
      el(RangeControl, {
        ...
        step: 1,
        onChange: (value) => {
          props.setAttributes({ vertical: value });
        },
      }),
      el(
        "p",
  ...
  class PortoProducts extends Component {
    ...
    componentDidUpdate(prevProps, prevState) {
      ...
      if ("selected" === attrs.category_type && 0 === categoriesList.length) {
        wp.apiFetch({ path: "/wc/v2/products/categories?per_page=99" }).then(
          function (obj) {
      ...
      if (
        $wrap.data("owl.carousel") &&
        ("products-slider" != attrs.view ||
          _this.getQuery() !== _this.state.query)
      ) {
        portoDestroyCarousel($wrap);
      } else if (
        $wrap.data("isotope") &&
        ("creative" != attrs.view || _this.getQuery() !== _this.state.query)
      ) {
      ...
      if (
        "products-slider" == attrs.view &&
        _this.state.products.length &&
        ("products-slider" !== prevProps.attributes.view ||
          prevState.products !== _this.state.products ||
          attrs.columns !== prevProps.attributes.columns ||
          attrs.navigation !== prevProps.attributes.navigation ||
          attrs.pagination !== prevProps.attributes.pagination ||
          attrs.dots_pos !== prevProps.attributes.dots_pos ||
          attrs.nav_pos !== prevProps.attributes.nav_pos ||
          attrs.nav_pos2 !== prevProps.attributes.nav_pos2 ||
          attrs.nav_type !== prevProps.attributes.nav_type ||
          attrs.count !== prevProps.attributes.count)
      ) {
        ...
        "creative" == attrs.view &&
        _this.state.products.length &&
        ("creative" !== prevProps.attributes.view ||
          prevState.products !== _this.state.products ||
          attrs.grid_layout !== prevProps.attributes.grid_layout ||
          attrs.grid_height !== prevProps.grid_height ||
          attrs.spacing !== prevProps.attributes.spacing)
      ) {
    ...
    getQuery() {
      ...
      if (attrs.count) {
        ...
        "creative" == attrs.view &&
        porto_block_vars.creative_layouts[Number(attrs.grid_layout)]
      ) {
        query.per_page =
          porto_block_vars.creative_layouts[Number(attrs.grid_layout)].length;
      }
      ...
      try {
        for (
          var _iterator = Object.keys(query)[Symbol.iterator](), _step;
    ...
    render() {
      ...
      for (var i = 1; i <= 14; i++) {
        grid_layouts.push({
          alt: i,
          src:
            porto_block_vars.shortcodes_url + "assets/images/cg/" + i + ".jpg",
        });
      }
      ...
      var inspectorControls = el(
        ...
        el(
          ...
          attrs.title &&
            el(SelectControl, {
              ...
              options: [
                { label: __("No Border", "porto-functionality"), value: "" },
                {
                  label: __("Bottom Border", "porto-functionality"),
                  value: "border-bottom",
                },
                {
                  label: __("Middle Border", "porto-functionality"),
                  value: "border-middle",
                },
              ],
              onChange: (value) => {
                setAttributes({ title_border_style: value });
              },
            }),
          el(SelectControl, {
          ...
          el(SelectControl, {
            ...
            options: [
              { label: __("All", "porto-functionality"), value: "" },
              {
                label: __("Selected", "porto-functionality"),
                value: "selected",
              },
            ],
            onChange: function onChange(value) {
          ...
          attrs.orderby != "rating" &&
            el(SelectControl, {
              label: __("Order", "porto-functionality"),
              value: attrs.order,
              options: [
                {
                  label: __("Descending", "porto-functionality"),
                  value: "desc",
                },
                { label: __("Ascending", "porto-functionality"), value: "asc" },
              ],
              onChange: (value) => {
        ...
        el(
          ...
          el(SelectControl, {
            ...
            multiple: true,
            options: [
              { label: __("All", "porto-functionality"), value: "all" },
              { label: __("Popular", "porto-functionality"), value: "popular" },
              { label: __("Date", "porto-functionality"), value: "date" },
              { label: __("Rating", "porto-functionality"), value: "rating" },
              { label: __("On Sale", "porto-functionality"), value: "onsale" },
            ],
            onChange: (value) => {
              setAttributes({ show_sort: value });
            },
          }),
          -1 !== attrs.show_sort.indexOf("popular") &&
            el(TextControl, {
              label: __('Title for "Sort by Popular"', "porto-functionality"),
              value: attrs.show_sales_title,
              onChange: function (value) {
                setAttributes({ show_sales_title: value });
              },
            }),
          -1 !== attrs.show_sort.indexOf("date") &&
            el(TextControl, {
              label: __('Title for "Sort by Date"', "porto-functionality"),
              value: attrs.show_new_title,
              onChange: function (value) {
                setAttributes({ show_new_title: value });
              },
            }),
          -1 !== attrs.show_sort.indexOf("rating") &&
            el(TextControl, {
              label: __('Title for "Sort by Rating"', "porto-functionality"),
              value: attrs.show_rating_title,
              onChange: function (value) {
                setAttributes({ show_rating_title: value });
              },
            }),
          -1 !== attrs.show_sort.indexOf("onsale") &&
            el(TextControl, {
              label: __('Title for "On Sale"', "porto-functionality"),
              value: attrs.show_onsale_title,
              onChange: function (value) {
                setAttributes({ show_onsale_title: value });
              },
            }),
          el(ToggleControl, {
          ...
          (attrs.category_filter || attrs.show_sort.length > 0) &&
            el(SelectControl, {
              label: __("Filter Style", "porto-functionality"),
              value: attrs.filter_style,
              options: [
                { label: __("Vertical", "porto-functionality"), value: "" },
                {
                  label: __("Horizontal", "porto-functionality"),
                  value: "horizontal",
                },
              ],
              onChange: (value) => {
                setAttributes({ filter_style: value });
              },
            }),
          attrs.view != "products-slider" &&
            el(SelectControl, {
              label: __("Pagination Style", "porto-functionality"),
              value: attrs.pagination_style,
              options: [
                {
                  label: __("No pagination", "porto-functionality"),
                  value: "",
                },
                {
                  label: __("Default", "porto-functionality"),
                ...
                {
                  label: __("Load more", "porto-functionality"),
                  value: "load_more",
                },
              ],
              onChange: (value) => {
                setAttributes({ pagination_style: value });
              },
            }),
          ("grid" == attrs.view || "products-slider" == attrs.view) &&
            el(RangeControl, {
              label: __("Columns", "porto-functionality"),
              value: attrs.columns,
              min: 1,
          ...
          ("grid" == attrs.view || "products-slider" == attrs.view) &&
            el(SelectControl, {
              ...
              options: [
                { label: __("Default", "porto-functionality"), value: "" },
                {
                  label: __("1/1 of content width", "porto-functionality"),
                  value: "1",
                },
                {
                  label: __("1/2 of content width", "porto-functionality"),
                  value: "2",
                },
                {
                  label: __("1/3 of content width", "porto-functionality"),
                  value: "3",
                },
                {
                  label: __("1/4 of content width", "porto-functionality"),
                  value: "4",
                },
                {
                  label: __("1/5 of content width", "porto-functionality"),
                  value: "5",
                },
                {
                  label: __("1/6 of content width", "porto-functionality"),
                  value: "6",
                },
                {
                  label: __("1/7 of content width", "porto-functionality"),
                  value: "7",
                },
                {
                  label: __("1/8 of content width", "porto-functionality"),
                  value: "8",
                },
              ],
              onChange: (value) => {
                setAttributes({ column_width: value });
              },
            }),
          "creative" == attrs.view &&
            el(PortoImageChoose, {
          ...
          "creative" == attrs.view &&
            el(TextControl, {
              ...
              onChange: (value) => {
                setAttributes({ grid_height: value });
              },
            }),
          ("creative" == attrs.view ||
            "grid" == attrs.view ||
          ...
          "list" != attrs.view &&
            el(SelectControl, {
              ...
              value:
                "creative" == attrs.view &&
                "onimage" != attrs.addlinks_pos &&
                "onimage2" != attrs.addlinks_pos &&
                "onimage3" != attrs.addlinks_pos
                  ? "onimage"
                  : attrs.addlinks_pos,
              options:
                "creative" == attrs.view
                  ? [
                      {
                        label: __("On Image", "porto-functionality"),
                        value: "onimage",
                      },
                      {
                        label: __(
                          "On Image with Overlay 1",
                          "porto-functionality"
                        ),
                        value: "onimage2",
                      },
                      {
                        label: __(
                          "On Image with Overlay 2",
                          "porto-functionality"
                        ),
                        value: "onimage3",
                      },
                    ]
                  : porto_block_vars.product_layouts,
              onChange: (value) => {
                setAttributes({ addlinks_pos: value });
              },
            }),
          ("divider" == attrs.view ||
            "grid" == attrs.view ||
          ...
          "products-slider" == attrs.view &&
            ...
            el(ToggleControl, {
              ...
              checked: attrs.show_nav_hover,
              onChange: (value) => {
                setAttributes({ show_nav_hover: value });
              },
            }),
          "products-slider" == attrs.view &&
            el(ToggleControl, {
          ...
          "products-slider" == attrs.view &&
            ...
            el(SelectControl, {
              ...
              value: attrs.dots_pos,
              options: [
                { label: __("Bottom", "porto-functionality"), value: "" },
                {
                  label: __("Top right", "porto-functionality"),
                  value: "show-dots-title-right",
                },
          ...
          "products-slider" == attrs.view &&
            ...
            el(SelectControl, {
              ...
              onChange: (value) => {
                setAttributes({ dots_style: value });
              },
            }),
          el(TextControl, {
            label: __("Animation Type", "porto-functionality"),
            value: attrs.animation_type,
            onChange: (value) => {
              setAttributes({ animation_type: value });
            },
            help: __(
              "Please check this url to see animation types.",
              "porto-functionality"
          ...
          el(TextControl, {
            ...
            value: attrs.animation_delay,
            onChange: (value) => {
              setAttributes({ animation_delay: value });
            },
          }),
          el(TextControl, {
            label: __("Animation Duration (ms)", "porto-functionality"),
      ...
      const product_layout = attrs.addlinks_pos
        ? attrs.addlinks_pos
        : porto_block_vars.product_type;
      let product_layout_cls = "";
      if ("list" != attrs.view) {
        if (
          "creative" == attrs.view &&
          "onimage" != product_layout &&
          "onimage2" != product_layout &&
          "onimage3" != product_layout
        ) {
      ...
      const renderProducts = this.state.products.map(function (product, index) {
        ...
        if (product.images.length) {
          ...
          typeof porto_swatches_params != "undefined" &&
          porto_swatches_params.placeholder_src
        ) {
        ...
        if (
          "creative" == attrs.view &&
          typeof item_classes[index % item_classes.length] != "undefined"
        ) {
        ...
        const add_links_html = el(
          "div",
          { className: "add-links-wrap" },
          el(
            "div",
            ...
            porto_block_vars.product_show_wl &&
              el(
                "div",
                { className: "yith-wcwl-add-to-wishlist" },
                el("div", {}, el("span", { className: "add_to_wishlist" }))
              ),
            ("list" == attrs.view || "onimage2" != attrs.addlinks_pos) &&
              el(
                "span",
                { className: "quickview" },
        ...
        return el(
          ...
          {
            className:
              "product-col product product-" + product_layout_cls + item_class,
          },
          el(
            "div",
            ...
            el(
              ...
              el("div", { className: "inner" }, image),
              "list" != attrs.view &&
                ("outimage_aq_onimage" == product_layout ||
                  "outimage_aq_onimage2" == product_layout ||
                  "awq_onimage" == product_layout ||
                  "onimage2" == product_layout ||
                  "onimage3" == product_layout ||
                  "quantity" == product_layout) &&
                el("div", { className: "links-on-image" }, add_links_html)
            ),
            el(
              "div",
              ...
              porto_block_vars.product_show_cats &&
                el(
                  "div",
              ...
              el("h3", { className: "product-title" }, product.name),
              el(
                "div",
                ...
                el(
                  "div",
                  {
                    ...
                    title: parseFloat(product.average_rating),
                  },
                  el("span", {
                    style: {
                      width: parseFloat(product.average_rating) * 20 + "%",
                    },
                  })
                )
              ),
              ...
              ("list" == attrs.view ||
                "default" == product_layout ||
                "onhover" == product_layout ||
                "outimage" == product_layout ||
                "onimage" == product_layout ||
                "quantity" == product_layout) &&
                add_links_html
            )
      ...
      var renderControls = el(
        ...
        attrs.title &&
          el("h2", {
            className: "products-title section-title",
            dangerouslySetInnerHTML: {
              __html: attrs.title.replace(/<script.*?\/script>/g, ""),
            },
          }),
        (attrs.show_sort.length || attrs.category_filter) &&
          el(
            "div",
            ...
            attrs.show_sort.length &&
              el(
                "ul",
                { className: "product-categories" },
                -1 !== attrs.show_sort.indexOf("all") &&
                  el(
                    "li",
                    { className: "current" },
                    el("a", {}, __("All", "porto-functionality"))
                  ),
                -1 !== attrs.show_sort.indexOf("popular") &&
                  el(
                    "li",
                    ...
                    el(
                      "a",
                      {},
                      attrs.show_sales_title
                        ? attrs.show_sales_title
                        : __("Best Seller", "porto-functionality")
                    )
                  ),
                -1 !== attrs.show_sort.indexOf("date") &&
                  el(
                    ...
                    el(
                      "a",
                      {},
                      attrs.show_new_title
                        ? attrs.show_new_title
                        : __("New Arrivals", "porto-functionality")
                    )
                  ),
                -1 !== attrs.show_sort.indexOf("rating") &&
                  el(
                    ...
                    el(
                      "a",
                      {},
                      attrs.show_rating_title
                        ? attrs.show_rating_title
                        : __("Best Rating", "porto-functionality")
                    )
                  ),
                -1 !== attrs.show_sort.indexOf("onsale") &&
                  el(
          ...
          el(
            ...
            "products-slider" === attrs.view &&
              el(
                "div",
                { className: "owl-stage-outer" },
                el("div", { className: "owl-stage" }, renderProducts)
              ),
            "products-slider" !== attrs.view && renderProducts,
            "creative" == attrs.view &&
              el("li", { className: "grid-col-sizer" })
          )
        )
      );

      return [
        el(BlockControls, null, el(Toolbar, { controls: viewControls })),
        inspectorControls,
        renderControls,
      ];
    }
...
(function (
  ...
  const PortoHeading = function (props) {
      ...
      el(
        ...
        el(
          ...
          el(SelectControl, {
            ...
            options: [
              { label: __("Custom Text", "porto-functionality"), value: "" },
              {
                label: __("Dymamic Content", "porto-functionality"),
                value: "dynamic",
              },
            ...
            onChange: (value) => {
              props.setAttributes({ text_source: value });
            },
          }),
          !attrs.text_source &&
            el(TextareaControl, {
          ...
          el(SelectControl, {
            ...
            options: [
              ...
              { label: __("div", "porto-functionality"), value: "div" },
              { label: __("p", "porto-functionality"), value: "p" },
              { label: __("span", "porto-functionality"), value: "span" },
            ],
            onChange: (value) => {
          ...
          el(SelectControl, {
            ...
            options: [
              { label: __("Select", "porto-functionality"), value: "" },
              { label: __("1", "porto-functionality"), value: "1" },
              { label: __("2", "porto-functionality"), value: "2" },
              { label: __("3", "porto-functionality"), value: "3" },
              { label: __("4", "porto-functionality"), value: "4" },
              { label: __("5", "porto-functionality"), value: "5" },
              { label: __("6", "porto-functionality"), value: "6" },
              { label: __("7", "porto-functionality"), value: "7" },
              { label: __("8", "porto-functionality"), value: "8" },
            ],
            onChange: (value) => {
              props.setAttributes({ line_clamp: value });
            },
          }),
          el(TextControl, {
            label: __("Link", "porto-functionality"),
            help: __(
              "Please leave empty, if text source is dynamic, so you want to add link automatically.",
              "porto-functionality"
            ),
            value: attrs.link,
            onChange: (value) => {
          ...
          el(ToggleControl, {
            ...
            onChange: (value) => {
              props.setAttributes({ nofollow: value });
            },
          })
        ),
        "dynamic" == attrs.text_source &&
          el(
            PanelBody,
            { title: __("Dynamic", "porto-functionality"), initialOpen: false },
            el(PortoDynamicContentControl, {
              label: __("Dynamic Content", "porto-functionality"),
              value: dynamic_content,
              options: {
        ...
        el(
          PanelBody,
          {
            title: __("TypeWriter Effect", "porto-functionality"),
            initialOpen: false,
          },
          el(ToggleControl, {
            ...
            onChange: (value) => {
              props.setAttributes({ enable_typewriter: value });
            },
          }),
          attrs.enable_typewriter &&
            el(TextControl, {
              label: __(
                "Animation Name e.g: fadeInUp, fadeIn and so on.",
                "porto-functionality"
              ),
              value: attrs.typewriter_animation,
              onChange: (value) => {
                props.setAttributes({ typewriter_animation: value });
              },
            }),
          attrs.enable_typewriter &&
            el(TextControl, {
              ...
              onChange: (value) => {
                props.setAttributes({ typewriter_delay: value });
              },
            }),
          attrs.enable_typewriter &&
            el(TextControl, {
              label: __(
                "Input min width that can work. (px)",
                "porto-functionality"
              ),
              value: attrs.typewriter_width,
              onChange: (value) => {
                props.setAttributes({ typewriter_width: value });
              },
            })
        ),
        el(
          PanelBody,
          { title: __("Animation", "porto-functionality"), initialOpen: false },
          el(TextControl, {
            label: __("Animation Type", "porto-functionality"),
            value: attrs.animation_type,
            help: __(
            ...
            value:
              typeof porto_content_type != "undefined"
                ...
                : {
                    ...
                    fontWeight: attrs.font_weight,
                    textTransform: attrs.text_transform,
                    lineHeight: attrs.line_height,
                    letterSpacing: attrs.letter_spacing,
                    color: attrs.color,
    ...
    if (attrs.enable_typewriter) {
      type_plugin = {
        ...
        "data-plugin-options": { startDelay: 0, minWindowWidth: 0 },
      };
      if (attrs.typewriter_delay) {
        type_plugin["data-plugin-options"]["startDelay"] = parseInt(
          attrs.typewriter_delay
        );
      }
      if (attrs.typewriter_width) {
        type_plugin["data-plugin-options"]["minWindowWidth"] = parseInt(
          attrs.typewriter_width
        );
      }
      if (attrs.typewriter_animation) {
        type_plugin["data-plugin-options"]["animationName"] = parseInt(
          attrs.typewriter_animation
        );
      }
    }
    ...
    if (
      attrs.text_source &&
      attrs.dynamic_content &&
      attrs.dynamic_content.source
    ) {
      if (
        "post" == attrs.dynamic_content.source &&
        "title" == attrs.dynamic_content.post_info
      ) {
        isLink = true;
      } else if (
        "tax" == attrs.dynamic_content.source &&
        "title" == attrs.dynamic_content.tax
      ) {
        isLink = true;
      }
    }
  ...
  if (
    typeof porto_content_type != "undefined" &&
    (porto_content_type || "" === porto_content_type)
  ) {
  ...
  registerBlockType("porto/porto-heading", {
    ...
    description: __(
      "Display the heading including product or post title with dynamic field function.",
      "porto-functionality"
    ),
...
(function (
  ...
  const PortoButton = function (props) {
          ...
          success: function (res) {
            if (res && res.success) {
              if (res.data) {
                ...
                attrs.dynamic_content &&
                attrs.dynamic_content.fallback
              ) {
    ...
    var inspectorControls = el(
      ...
      el(
        ...
        el(
          ...
          el(SelectControl, {
            ...
            options: [
              { label: __("Default", "porto-functionality"), value: "" },
              { label: __("Modern", "porto-functionality"), value: "modern" },
              { label: __("Outline", "porto-functionality"), value: "borders" },
            ],
            onChange: (value) => {
          ...
          el(SelectControl, {
            ...
            value: attrs.size,
            options: [
              { label: __("Extra Small", "porto-functionality"), value: "xs" },
              { label: __("Small", "porto-functionality"), value: "sm" },
              { label: __("Medium", "porto-functionality"), value: "md" },
              { label: __("Large", "porto-functionality"), value: "lg" },
              { label: __("Extra Large", "porto-functionality"), value: "xl" },
            ],
            onChange: (value) => {
          ...
          el(ToggleControl, {
            ...
            onChange: (value) => {
              props.setAttributes({ is_block: value });
            },
          }),
          el(SelectControl, {
            ...
            options: [
              { label: __("Default", "porto-functionality"), value: "default" },
              { label: __("Primary", "porto-functionality"), value: "primary" },
              {
                label: __("Secondary", "porto-functionality"),
                value: "secondary",
              },
              ...
              { label: __("Dark", "porto-functionality"), value: "dark" },
              { label: __("Light", "porto-functionality"), value: "light" },
            ],
            onChange: (value) => {
          ...
          attrs.title &&
            el(SelectControl, {
              ...
              options: [
                { label: __("No Effect", "porto-functionality"), value: "" },
                {
                  label: __("Switch Left", "porto-functionality"),
                  value: "hover-text-switch-left",
                },
                {
                  label: __("Switch Up", "porto-functionality"),
                  value: "hover-text-switch-up",
                },
                {
                  label: __("Marquee Left", "porto-functionality"),
                  value: "hover-text-marquee-left",
                },
                {
                  label: __("Marquee Up", "porto-functionality"),
                  value: "hover-text-marquee-up",
                },
                {
                  label: __("Marquee Down", "porto-functionality"),
                  value: "hover-text-marquee-down",
                },
              ],
              onChange: (value) => {
                props.setAttributes({ hover_text_effect: value });
              },
            })
        ),
        el(
          PanelBody,
          { title: __("Icon", "porto-functionality"), initialOpen: false },
          el(TextControl, {
            label: __(
              "Icon Class (ex: fas fa-pencil-alt)",
              "porto-functionality"
            ),
            value: attrs.icon_cls,
            onChange: (value) => {
              props.setAttributes({ icon_cls: value });
            },
          }),
          attrs.icon_cls &&
            el(SelectControl, {
              ...
              onChange: (value) => {
                props.setAttributes({ icon_pos: value });
              },
            }),
          attrs.icon_cls &&
            el(SelectControl, {
        ...
        el(
          ...
          attrs.animation_type &&
            -1 !== attrs.animation_type.indexOf("revealDir") &&
            el(
              "span",
    ...
    var renderControls = el(
      ...
      el(
        "style",
        null,
        attrs.icon_cls && attrs.spacing
          ? ".editor-styles-wrapper ." +
              selectorCls +
              " i { margin-" +
              ("right" == attrs.icon_pos ? "left" : "right") +
              ": " +
              attrs.spacing +
              "}"
          : "",
        portoGenerateStyleOptionsCSS(
          style_options,
          "editor-styles-wrapper ." + selectorCls
        ),
        portoGenerateTypographyCSS(
          font_settings,
          "editor-styles-wrapper ." + selectorCls
      ...
      el(
        ...
        attrs.icon_cls &&
          "left" == attrs.icon_pos &&
          el("i", { className: attrs.icon_cls }),
        el(
          "span",
          { className: "btn-text", "data-text": btn_title },
          btn_title
        ),
        attrs.icon_cls &&
          "right" == attrs.icon_pos &&
          el("i", { className: attrs.icon_cls })
      )
    );
  ...
  registerBlockType("porto/porto-button", {
    title: "Porto Button",
    description: __(
      "Create a beautiful layout action with dynamic feature.",
      "porto-functionality"
    ),
    icon: "porto",
    category: "porto",
...
(function (
  ...
  const PortoSection = function (props) {
      ...
      el(
        ...
        el(
          ...
          el(SelectControl, {
            ...
            value: attrs.tag,
            options: [
              { label: __("section", "porto-functionality"), value: "section" },
              { label: __("div", "porto-functionality"), value: "div" },
              { label: __("article", "porto-functionality"), value: "article" },
            ],
            onChange: (value) => {
              props.setAttributes({ tag: value });
            },
          ...
          el(ToggleControl, {
            ...
            onChange: (value) => {
              props.setAttributes({ flex_container: value });
            },
          }),
          attrs.flex_container &&
            el(ToggleControl, {
              label: __("Is Flex wrap?", "porto-functionality"),
              help: __(
                "If check this option, direct child items break into multiple lines."
              ),
              checked: attrs.flex_wrap,
              onChange: (value) => {
                props.setAttributes({ flex_wrap: value });
              },
            }),
          attrs.flex_container &&
            el(SelectControl, {
              ...
              options: [
                { label: __("Default", "porto-functionality"), value: "" },
                { label: __("Top", "porto-functionality"), value: "start" },
                { label: __("Middle", "porto-functionality"), value: "center" },
                { label: __("Bottom", "porto-functionality"), value: "end" },
              ],
              onChange: (value) => {
                props.setAttributes({ valign: value });
              },
            }),
          attrs.flex_container &&
            el(SelectControl, {
              ...
              options: [
                ...
                {
                  label: __("Space Between", "porto-functionality"),
                  value: "between",
                },
                {
                  label: __("Space Around", "porto-functionality"),
                  value: "around",
                },
              ],
              onChange: (value) => {
                props.setAttributes({ halign: value });
              },
            })
        ),
        el(
          ...
          el(TextControl, {
            ...
            onChange: (value) => {
              props.setAttributes({ bg_img_url: value });
            },
          }),
          attrs.bg_img_url &&
            el(SelectControl, {
              ...
              options: [
                { label: __("Default", "porto-functionality"), value: "" },
                {
                  label: __("No Repeat", "porto-functionality"),
                  value: "no-repeat",
                },
                { label: __("Repeat", "porto-functionality"), value: "repeat" },
                {
                  label: __("Repeat X", "porto-functionality"),
                  value: "repeat-x",
                },
                {
                  label: __("Repeat Y", "porto-functionality"),
                  value: "repeat-y",
                },
              ],
              onChange: (value) => {
                props.setAttributes({ bg_repeat: value });
              },
            }),
          attrs.bg_img_url &&
            el(SelectControl, {
              ...
              options: [
                { label: __("Default", "porto-functionality"), value: "" },
                {
                  label: __("Center Center", "porto-functionality"),
                  value: "center center",
                },
                {
                  label: __("Center Left", "porto-functionality"),
                  value: "center left",
                },
                {
                  label: __("Center Right", "porto-functionality"),
                  value: "center right",
                },
                {
                  label: __("Top Center", "porto-functionality"),
                  value: "top center",
                },
                {
                  label: __("Top Left", "porto-functionality"),
                  value: "top left",
                },
                {
                  label: __("Top Right", "porto-functionality"),
                ...
                {
                  label: __("Bottom Center", "porto-functionality"),
                  value: "bottom center",
                },
                {
                  label: __("Bottom Left", "porto-functionality"),
                  value: "bottom left",
                },
                {
                  label: __("Bottom Right", "porto-functionality"),
                  value: "bottom right",
                },
              ],
              onChange: (value) => {
                props.setAttributes({ bg_pos: value });
              },
            }),
          attrs.bg_img_url &&
            el(SelectControl, {
              ...
              options: [
                { label: __("Default", "porto-functionality"), value: "" },
                { label: __("Cover", "porto-functionality"), value: "cover" },
                {
                  label: __("Contain", "porto-functionality"),
                  value: "contain",
                },
                { label: __("Auto", "porto-functionality"), value: "auto" },
                {
                  label: __("100% auto", "porto-functionality"),
                  value: "100% auto",
                },
                {
                  label: __("auto 100%", "porto-functionality"),
                  value: "auto 100%",
                },
              ],
              onChange: (value) => {
                props.setAttributes({ bg_size: value });
              },
            }),
          attrs.bg_img_url &&
            el(RangeControl, {
              ...
              step: 0.1,
              onChange: (value) => {
                props.setAttributes({ parallax_speed: value });
              },
            }),
          attrs.bg_img_url &&
            el(
              ...
              {},
              __(
                "Enter parallax speed ratio if you want to use parallax effect. (Note: Standard value is 1.5, min value is 1. Leave empty if you don't want.)"
              )
            ),
          el(TextControl, {
            ...
            onChange: (value) => {
              props.setAttributes({ bg_video: value });
            },
          })
        ),
        el(
          PanelBody,
          {
            title: __("Shape Divider", "porto-functionality"),
            initialOpen: false,
          },
          el(SelectControl, {
            ...
            onChange: (value) => {
              props.setAttributes({ top_bottom: value });
            },
          }),
          attrs.top_bottom == "top" &&
            el(SelectControl, {
              label: __("Top Divider Type", "porto-functionality"),
              value: attrs.top_divider_type,
              options: porto_block_vars.divider_type,
              onChange: (value) => {
                props.setAttributes({ top_divider_type: value });
              },
            }),
          attrs.top_bottom == "top" &&
            attrs.top_divider_type == "custom" &&
            el(TextareaControl, {
              label: __("Please writer your svg code.", "porto-functionality"),
              value: attrs.top_divider_custom,
              onChange: (value) => {
                props.setAttributes({ top_divider_custom: value });
              },
            }),
          attrs.top_bottom == "top" &&
            attrs.top_divider_type != "none" &&
            el(PanelColorSettings, {
          ...
          attrs.top_bottom == "top" &&
            ...
            el(TextControl, {
              ...
              onChange: (value) => {
                props.setAttributes({ top_divider_height: value });
              },
            }),
          attrs.top_bottom == "top" &&
            attrs.top_divider_type != "none" &&
            el(ToggleControl, {
              ...
              onChange: (value) => {
                props.setAttributes({ top_divider_flip: value });
              },
            }),
          attrs.top_bottom == "top" &&
            attrs.top_divider_type != "none" &&
            el(ToggleControl, {
              ...
              onChange: (value) => {
                props.setAttributes({ top_divider_invert: value });
              },
            }),
          attrs.top_bottom == "top" &&
            attrs.top_divider_type != "none" &&
            el(TextControl, {
              ...
              onChange: (value) => {
                props.setAttributes({ top_divider_class: value });
              },
            }),

          attrs.top_bottom == "bottom" &&
            el(SelectControl, {
              label: __("Bottom Divider Type", "porto-functionality"),
              value: attrs.bottom_divider_type,
              options: porto_block_vars.divider_type,
              onChange: (value) => {
                props.setAttributes({ bottom_divider_type: value });
              },
            }),
          attrs.top_bottom == "bottom" &&
            attrs.bottom_divider_type == "custom" &&
            el(TextareaControl, {
              label: __("Please writer your svg code.", "porto-functionality"),
              value: attrs.bottom_divider_custom,
              onChange: (value) => {
                props.setAttributes({ bottom_divider_custom: value });
              },
            }),
          attrs.top_bottom == "bottom" &&
            attrs.bottom_divider_type != "none" &&
            el(PanelColorSettings, {
              title: __("Divider Color", "porto-functionality"),
              initialOpen: false,
              colorSettings: [
          ...
          attrs.top_bottom == "bottom" &&
            ...
            el(TextControl, {
              ...
              onChange: (value) => {
                props.setAttributes({ bottom_divider_height: value });
              },
            }),
          attrs.top_bottom == "bottom" &&
            attrs.bottom_divider_type != "none" &&
            el(ToggleControl, {
              ...
              onChange: (value) => {
                props.setAttributes({ bottom_divider_flip: value });
              },
            }),
          attrs.top_bottom == "bottom" &&
            attrs.bottom_divider_type != "none" &&
            el(ToggleControl, {
              ...
              onChange: (value) => {
                props.setAttributes({ bottom_divider_invert: value });
              },
            }),
          attrs.top_bottom == "bottom" &&
            attrs.bottom_divider_type != "none" &&
            el(TextControl, {
              ...
              onChange: (value) => {
                props.setAttributes({ bottom_divider_class: value });
              },
            })
        )
      ),
    ...
    if (attrs.top_divider_type != "" && attrs.top_divider_type != "none") {
      ...
      if (attrs.top_divider_type == "custom") {
        if (attrs.top_divider_custom)
          top_divider_attr.dangerouslySetInnerHTML = {
            __html: attrs.top_divider_custom,
          };
      } else {
        top_divider_attr.dangerouslySetInnerHTML = {
          __html: porto_block_vars.shape_divider[attrs.top_divider_type],
        };
      }
    }

    const bottom_divider_attr = {
      style: {},
      className: "shape-divider shape-divider-bottom",
    };
    if (
      attrs.bottom_divider_type != "" &&
      attrs.bottom_divider_type != "none"
    ) {
      ...
      if (attrs.bottom_divider_type == "custom") {
        if (attrs.bottom_divider_custom)
          bottom_divider_attr.dangerouslySetInnerHTML = {
            __html: attrs.bottom_divider_custom,
          };
      } else {
        bottom_divider_attr.dangerouslySetInnerHTML = {
          __html: porto_block_vars.shape_divider[attrs.bottom_divider_type],
        };
      }
    }
    ...
    const renderControls = el(
      ...
      attrs.top_divider_type != "" &&
        attrs.top_divider_type != "none" &&
        el("div", top_divider_attr),
      !attrs.add_container && el(InnerBlocks),
      attrs.add_container &&
        el("div", { className: containerCls }, el(InnerBlocks)),
      attrs.bottom_divider_type != "" &&
        attrs.bottom_divider_type != "none" &&
        el("div", bottom_divider_attr)
    );
  ...
  registerBlockType("porto/porto-section", {
    ...
    category: "porto",
    description: __(
      "Place content elements with shape divider, section separator, flexbox container.",
      "porto-functionality"
    ),
    keywords: [
      "background",
  ...
  class PortoProductCategories extends Component {
    ...
    componentDidUpdate(prevProps, prevState) {
      ...
      if (
        ...
        ("products-slider" !== prevProps.attributes.view ||
          prevState.categoriesList !== categoriesList ||
          attrs.columns !== prevProps.attributes.columns ||
          attrs.navigation !== prevProps.attributes.navigation ||
          attrs.pagination !== prevProps.attributes.pagination ||
          attrs.dots_pos !== prevProps.attributes.dots_pos ||
          ...
          attrs.nav_pos2 !== prevProps.attributes.nav_pos2 ||
          attrs.nav_type !== prevProps.attributes.nav_type ||
          attrs.number !== prevProps.attributes.number)
      ) {
        if ($wrap.data("owl.carousel")) {
          portoDestroyCarousel($wrap);
        }
    ...
    render() {
      ...
      const categories_options = [
        { label: __("None", "porto-functionality"), value: "" },
        {
          label: __("Display Top Level categories", "porto-functionality"),
          value: "0",
        },
      ];
      allcategories &&
      ...
      var inspectorControls = el(
        ...
        el(
          ...
          el("p", { className: "" }, __("Categories", "porto-functionality")),
          el(
            "div",
            { className: "porto-categories-list" },
            allcategories &&
              allcategories.map(function (cat, index) {
                if (
                  attrs.parent &&
                  parseInt(attrs.parent) !== parseInt(cat.parent)
                ) {
                  return;
                }
                return el(CheckboxControl, {
                  ...
                  checked:
                    attrs.ids && attrs.ids.split(",").indexOf("" + cat.id) > -1,
                  onChange: (is_add) => {
                    let ids_arr = attrs.ids ? attrs.ids.split(",") : [];
                    if (is_add) {
                      ids_arr = [].concat(_makeConsumableArray(ids_arr), [
                        cat.id,
                      ]);
                    } else {
          ...
          el(SelectControl, {
            ...
            value: attrs.orderby,
            options: [
              { label: __("Title", "porto-functionality"), value: "name" },
              { label: __("ID", "porto-functionality"), value: "id" },
              {
                label: __("Product Count", "porto-functionality"),
                value: "count",
              },
              {
                label: __("Description", "porto-functionality"),
              ...
              {
                label: __("Term Group", "porto-functionality"),
                value: "term_group",
              },
            ],
            onChange: (value) => {
        ...
        el(
          ...
          el(SelectControl, {
            ...
            options: [
              {
                label: __("Inner Middle Left", "porto-functionality"),
                value: "middle-left",
              },
              {
                label: __("Inner Middle Center", "porto-functionality"),
                value: "middle-center",
              },
              {
                label: __("Inner Middle Right", "porto-functionality"),
                value: "middle-right",
              },
              {
                label: __("Inner Bottom Left", "porto-functionality"),
                value: "bottom-left",
              },
              {
                label: __("Inner Bottom Center", "porto-functionality"),
                value: "bottom-center",
              },
              {
                label: __("Inner Bottom Right", "porto-functionality"),
                value: "bottom-right",
              },
              {
                label: __("Outside", "porto-functionality"),
            ...
            onChange: (value) => {
              setAttributes({ text_position: value });
            },
          }),
          el(RangeControl, {
            ...
            max: 100,
            onChange: (value) => {
              props.setAttributes({ overlay_bg_opacity: value });
            },
          }),
          el(SelectControl, {
          ...
          el(SelectControl, {
            ...
            options: [
              { label: __("Image", "porto-functionality"), value: "" },
              { label: __("Icon", "porto-functionality"), value: "icon" },
            ],
            onChange: (value) => {
              setAttributes({ media_type: value });
            },
          }),
          el(ToggleControl, {
            ...
            onChange: (value) => {
              props.setAttributes({ show_sub_cats: value });
            },
          }),
          el(ToggleControl, {
            ...
            onChange: (value) => {
              props.setAttributes({ show_featured: value });
            },
            help: __(
              "If you check this option, a featured product in each category will be displayed under the product category.",
              "porto-functionality"
            ),
          }),
          el(ToggleControl, {
            ...
            onChange: (value) => {
              props.setAttributes({ hide_count: value });
            },
          }),
          el(SelectControl, {
            label: __("Hover Effect", "porto-functionality"),
            value: attrs.hover_effect,
            options: [
              { label: __("Normal", "porto-functionality"), value: "" },
              {
                label: __(
                  "Display product count on hover",
                  "porto-functionality"
                ),
                value: "show-count-on-hover",
              },
            ],
            onChange: (value) => {
              setAttributes({ hover_effect: value });
            },
          }),
          "icon" != attrs.media_type &&
            el(SelectControl, {
              label: __("Image Size", "porto-functionality"),
              value: attrs.image_size,
              options: porto_block_vars.image_sizes,
      ...
      if ("grid" == attrs.view) {
        ...
        classes +=
          " products-slider owl-carousel owl-loaded pcols-lg-" + attrs.columns;
        if (attrs.navigation) {
          if (attrs.nav_pos) classes += " " + attrs.nav_pos;
          if (
            (!attrs.nav_pos || "nav-center-images-only" == attrs.nav_pos) &&
            attrs.nav_pos2
          ) {
            classes += " " + attrs.nav_pos2;
          }
      ...
      let category_view =
          "category-pos-" +
          attrs.text_position.split("-")[0] +
          (attrs.text_position.split("-").length >= 2
            ? " category-text-" + attrs.text_position.split("-")[1]
            : "") +
          ("light" != attrs.text_color
            ? " category-color-" + attrs.text_color
            : ""),
        item_classes =
          porto_block_vars.creative_layouts[Number(attrs.grid_layout)];
      ...
      const renderCats = this.state.categoriesList.map(function (cat, index) {
        ...
        return el(
          ...
          el(
            ...
            "icon" == attrs.media_type &&
              cat.cat_icon &&
              el("i", { className: cat.cat_icon }),
            ("icon" != attrs.media_type || !cat.cat_icon) &&
              el("span", { className: "thumb-info-wrapper tf-none" }, image),
            "category-pos-outside" != category_view &&
              el(
                "span",
                ...
                el(
                  ...
                  el("h3", {
                    className: "sub-title thumb-info-inner",
      ...
      var renderControls = el(
        "div",
        {
          className:
            "porto-products" +
            (attrs.hover_effect ? " " + attrs.hover_effect : "") +
            (attrs.className ? " " + attrs.className.trim() : ""),
        },
        attrs.title &&
          el("h2", {
            className: "products-title section-title",
        ...
        el(
          ...
          {
            className:
              "products products-container" + classes + " " + category_view,
          },
          "products-slider" === attrs.view &&
            el(
              "div",
              { className: "owl-stage-outer" },
              el("div", { className: "owl-stage" }, renderCats)
            ),
          "products-slider" !== attrs.view && renderCats,
          "creative" == attrs.view && el("li", { className: "grid-col-sizer" })
        )
      );
...
(function (
  ...
  class PortoMasonryContainer extends Component {
          ...
          jQuery.ajax({
            ...
            success: function (res) {
              ...
              for (var i = 0; i < children.length; i++) {
                ...
                if (
                  this_obj.classList.contains("grid-col-sizer") ||
                  this_obj.classList.contains("block-list-appender")
                ) {
                  continue;
                }
                ...
                const cls_arr =
                  item_classes[i % item_classes.length].split(" ");
                for (var j = 0; j < this_obj.classList.length; j++) {
                  if (
                    0 === this_obj.classList.item(j).indexOf("grid-col-") ||
                    0 === this_obj.classList.item(j).indexOf("grid-height-")
                  ) {
              ...
              counterWillUpdate = setTimeout(function () {
                for (var i = 0; i < children.length; i++) {
                  ...
                  this_obj.style.width =
                    (
                      (this_obj.offsetWidth / this_obj.parentNode.offsetWidth) *
                      100
                    ).toFixed(4) + "%";
    ...
    componentDidMount() {
      ...
      setTimeout(() => {
        const $wrap = jQuery("#block-" + clientId)
          .find(".block-editor-block-list__layout")
          .eq(0);
        $wrap.isotope("layout");
      }, 100);
    ...
    componentDidUpdate(prevProps, prevState) {
      ...
      if (
        "preset" == attrs.layout &&
        (attrs.layout != prevProps.attributes.layout ||
          attrs.grid_layout != prevProps.attributes.grid_layout ||
          attrs.grid_height != prevProps.attributes.grid_height)
      ) {
        this.initMasonry();
      } else if ("preset" != attrs.layout) {
        const wrap_obj = $wrap.get(0);
        if (
          wrap_obj.previousSibling &&
          "alt" === wrap_obj.previousSibling.tagName.toLowerCase()
        ) {
    ...
    render() {
      ...
      var inspectorControls = el(
        ...
        el(SelectControl, {
          ...
          options: [
            {
              label: __("Custom Masonry Layout", "porto-functionality"),
              value: "",
            },
            {
              label: __("Predefined Grid Layout", "porto-functionality"),
              value: "preset",
            },
          ],
          onChange: (value) => {
        ...
        "preset" == attrs.layout &&
          el(TextControl, {
            ...
            value: attrs.grid_height,
            onChange: (value) => {
              props.setAttributes({ grid_height: value });
            },
          }),
        el(TextControl, {
          ...
          onChange: (value) => {
            props.setAttributes({ gutter_size: value });
          },
          help: __(
            "Enter value including any valid CSS unit, ex: 30px.",
            "porto-functionality"
      ...
      if (attrs.gutter_size) {
        const gutter_size_number = attrs.gutter_size.replace(/[^.0-9]/g, ""),
          gutter_size = attrs.gutter_size.replace(
            gutter_size_number,
            "" + parseFloat(gutter_size_number) / 2
          ),
          gutter_size_escaped = gutter_size.replace(/<script.*?\/script>/g, "");
        gutter_style =
          "." +
          cont_cls +
          " > .block-editor-inner-blocks > .block-editor-block-list__layout > div { padding: " +
          gutter_size_escaped +
          "}";
        gutter_style +=
          "." +
          cont_cls +
          " > .block-editor-inner-blocks > .block-editor-block-list__layout{margin:-" +
          gutter_size_escaped +
          " -" +
          gutter_size_escaped +
          " " +
      ...
      var renderControls = el(
        "div",
        {
          className:
            ...
            cont_cls +
            ("preset" == attrs.layout ? " porto-preset-layout" : "") +
            (attrs.className ? " " + attrs.className : ""),
          style: { minHeight: "200px" },
        },
        attrs.gutter_size && el("style", {}, gutter_style),
        el(InnerBlocks, {
          allowedBlocks: ["porto/porto-grid-item"],
          initMasonry: this.initMasonry,
        })
      );
...
(function (
  ...
  class PortoMasonryItem extends Component {
    ...
    componentDidMount() {
      ...
      if (
        $this.closest(".porto-preset-layout").length &&
        $wrap.length &&
        $wrap.data("isotope")
      ) {
        const item_classes =
            porto_block_vars.creative_layouts[
              Number($wrap.data("grid_layout"))
            ],
          cls_arr =
            item_classes[$this.index() % item_classes.length].split(" ");
        cls_arr.map(function (cls) {
          this_obj.classList.add(cls);
        });
        this_obj.style.width =
    ...
    render() {
      ...
      var inspectorControls = el(
        ...
        el(TextControl, {
          ...
          help: __(
            "Enter value including any valid CSS unit, ex: 25%.",
            "porto-functionality"
          ),
        })
      );
...
(function (
  ...
  if (porto_block_vars.legacy_mode == "1") {
    ...
    const PortoProductsWidget = function (props) {
      ...
      var inspectorControls = el(
        ...
        "top_rated" !== attrs.show &&
          "recent_view" !== attrs.show &&
          el(SelectControl, {
            label: __("Order by", "porto-functionality"),
            value: attrs.orderby,
            options: [
              { label: __("Date", "porto-functionality"), value: "date" },
              { label: __("Price", "porto-functionality"), value: "price" },
              {
                label: __("Total Sales", "porto-functionality"),
                value: "sales",
              },
              { label: __("Random", "porto-functionality"), value: "rand" },
            ],
            onChange: (value) => {
        ...
        "top_rated" !== attrs.show &&
          ...
          el(SelectControl, {
            ...
            value: attrs.order,
            options: [
              { label: __("Descending", "porto-functionality"), value: "desc" },
              { label: __("Ascending", "porto-functionality"), value: "asc" },
            ],
            onChange: (value) => {
        ...
        el(ToggleControl, {
          ...
          onChange: (value) => {
            props.setAttributes({ hide_free: value });
          },
        }),
        el(ToggleControl, {
          ...
          onChange: (value) => {
            props.setAttributes({ show_hidden: value });
          },
        })
      );
    ...
    const PortoPortfolios = (props) => {
      ...
      if (
        (attrs.portfolio_layout === "grid" ||
          attrs.portfolio_layout === "masonry" ||
          attrs.portfolio_layout === "timeline" ||
          attrs.portfolio_layout === "creative" ||
          attrs.portfolio_layout === "masonry-creative") &&
        "left-info-no-bg" === attrs.info_view
      ) {
        ...
        if (attrs.custom_portfolios) {
          infoColorSettings.push({
            label: __(
              "Info Color for custom portfolios",
              "porto-functionality"
            ),
        ...
        <InspectorControls>
          ...
          >
            ...
            <SelectControl
              ...
              onChange={(value) => {
                props.setAttributes({ portfolio_layout: value });
              }}
            />
            ...
            {"masonry-creative" === attrs.portfolio_layout && (
              <SelectControl
                ...
                onChange={(value) => {
                  props.setAttributes({ masonry_layout: value });
                }}
              />
            )}
            {("large" == attrs.portfolio_layout ||
              "fullscreen" == attrs.portfolio_layout) && (
              <TextControl
                label={__("Content Animation", "porto-functionality")}
                value={attrs.content_animation}
                onChange={(value) => {
                  props.setAttributes({ content_animation: value });
                }}
                help={__(
                  "Please check this url to see animation types.",
                  "porto-functionality"
            ...
            {(attrs.portfolio_layout === "grid" ||
              ...
              <SelectControl
                ...
                options={[
                  {
                    label: __("Standard", "porto-functionality"),
                    value: "classic",
                  },
                  {
                    label: __("Default", "porto-functionality"),
                  ...
                  {
                    label: __("No Margin", "porto-functionality"),
                    value: "full",
                  },
                  {
                    label: __("Out of Image", "porto-functionality"),
                    value: "outimage",
                  },
                ]}
                onChange={(value) => {
            ...
            {(attrs.portfolio_layout === "grid" ||
              ...
              <SelectControl
                ...
                options={[
                  { label: __("Standard", "porto-functionality"), value: "" },
                  {
                    label: __("Left Info", "porto-functionality"),
                    value: "left-info",
                  },
                  {
                    label: __("Left Info & No bg", "porto-functionality"),
                    value: "left-info-no-bg",
                  },
                  {
                    label: __("Centered Info", "porto-functionality"),
                    value: "centered-info",
                  },
                  {
                    label: __("Bottom Info", "porto-functionality"),
                    value: "bottom-info",
                  },
                  {
                    label: __("Bottom Info Dark", "porto-functionality"),
                    value: "bottom-info-dark",
                  },
                  {
                    label: __("Hide Info Hover", "porto-functionality"),
                    value: "hide-info-hover",
                  },
                  {
                    label: __("Plus Icon", "porto-functionality"),
                    value: "plus-icon",
                  },
                ]}
                onChange={(value) => {
                  props.setAttributes({ info_view: value });
                }}
              />
            )}
            {(attrs.portfolio_layout === "grid" ||
              ...
              "left-info-no-bg" === attrs.info_view && (
                <TextControl
                  label={__(
                    "Portfolio Indexes to use custom info color",
                    "porto-functionality"
                  )}
                  value={attrs.custom_portfolios}
                  onChange={(value) => {
                    props.setAttributes({ custom_portfolios: value });
                  }}
                  help={__(
                    "comma separated list of portfolio indexes",
                    "porto-functionality"
                  )}
                />
              )}
            ...
            {(attrs.portfolio_layout === "grid" ||
              ...
              <SelectControl
                ...
                options={[
                  { label: __("Standard", "porto-functionality"), value: "" },
                  {
                    label: __("Alternate", "porto-functionality"),
                    value: "alternate-info",
                  },
                  {
                    label: __("Alternate with Plus", "porto-functionality"),
                    value: "alternate-with-plus",
                  },
                  {
                    label: __("No Style", "porto-functionality"),
                    value: "no-style",
                  },
                ]}
                onChange={(value) => {
                  props.setAttributes({ info_view_type_style: value });
                }}
              />
            )}
            <SelectControl
            ...
            <SelectControl
              ...
              options={[
                { label: __("Standard", "porto-functionality"), value: "" },
                {
                  label: __("Darken", "porto-functionality"),
                  darken: "alternate-info",
                },
                {
                  label: __("Lighten", "porto-functionality"),
                  value: "lighten",
                },
                {
                  label: __("Transparent", "porto-functionality"),
                  value: "hide-wrapper-bg",
                },
              ]}
              onChange={(value) => {
                props.setAttributes({ thumb_bg: value });
              }}
            />
            <SelectControl
              ...
              options={[
                { label: __("Standard", "porto-functionality"), value: "" },
                { label: __("Zoom", "porto-functionality"), darken: "zoom" },
                {
                  label: __("Slow Zoom", "porto-functionality"),
                  value: "slow-zoom",
                },
                {
                  label: __("No Zoom", "porto-functionality"),
                  value: "no-zoom",
                },
              ]}
              onChange={(value) => {
                props.setAttributes({ thumb_image: value });
              }}
            />
            {(attrs.portfolio_layout === "grid" ||
              attrs.portfolio_layout === "masonry" ||
              ...
              <SelectControl
                ...
                onChange={(value) => {
                  props.setAttributes({ image_counter: value });
                }}
              />
            )}
            <SelectControl
              ...
              onChange={(value) => {
                props.setAttributes({ show_lightbox_icon: value });
              }}
            />
          </PanelBody>
          <PanelBody
            title={__("Portfolio Selector", "porto-functionality")}
            initialOpen={false}
          >
            <PortoAjaxSelect2Control
              ...
              multiple="1"
              onChange={(value) => {
                props.setAttributes({ cats: value });
              }}
            />
            <PortoAjaxSelect2Control
            ...
            <SelectControl
              ...
              options={[
                ...
                { label: __("Date", "porto-functionality"), value: "date" },
                { label: __("ID", "porto-functionality"), value: "ID" },
                { label: __("Author", "porto-functionality"), value: "author" },
                { label: __("Title", "porto-functionality"), value: "title" },
                {
                  label: __("Modified", "porto-functionality"),
                  value: "modified",
                },
                { label: __("Random", "porto-functionality"), value: "rand" },
                {
                  label: __("Comment count", "porto-functionality"),
                  value: "comment_count",
                },
                {
                  label: __("Menu order", "porto-functionality"),
                  value: "menu_order",
                },
              ]}
              onChange={(value) => {
            ...
            <PortoAjaxSelect2Control
              ...
              multiple="1"
              help={__(
                "Will Only work with ajax on page settings",
                "porto-functionality"
              )}
              onChange={(value) => {
            ...
            <SelectControl
              ...
              options={[
                { label: __("Select", "porto-functionality"), value: "" },
                {
                  label: __("Pagination", "porto-functionality"),
                  value: "pagination",
                },
                {
                  label: __("Load More (Button)", "porto-functionality"),
                  value: "load-more-btn",
                },
              ]}
              onChange={(value) => {
                props.setAttributes({ load_more_posts: value });
              }}
            />
            <ToggleControl
            ...
            {attrs.filter && (
              <SelectControl
                ...
                value={attrs.filter_style}
                options={[
                  { label: __("Style 1", "porto-functionality"), value: "" },
                  {
                    label: __("Style 2", "porto-functionality"),
                    value: "style-2",
                  },
                  {
                    label: __("Style 3", "porto-functionality"),
                    value: "style-3",
                  },
                ]}
                onChange={(value) => {
                  props.setAttributes({ filter_style: value });
                }}
              />
            )}
            <ToggleControl
              ...
              onChange={(value) => {
                props.setAttributes({ ajax_load: value });
              }}
            />
            {attrs.ajax_load && (
              <ToggleControl
                ...
                onChange={(value) => {
                  props.setAttributes({ ajax_modal: value });
                }}
              />
            )}
          </PanelBody>
      ...
      const inspectorControls = (
        <InspectorControls>
          ...
          >
            ...
            <RangeControl
              label={__(
                "Items to show on Large Desktop",
                "porto-functionality"
              )}
              value={attrs.items}
              min="1"
          ...
          >
            ...
            {attrs.slider_config &&
              attrs.show_nav &&
              (attrs.nav_pos === "" ||
                attrs.nav_pos === "nav-center-images-only") && (
                <SelectControl
            ...
            {attrs.slider_config && (
              <SelectControl
                ...
                options={[
                  {
                    label: __("Theme Options", "porto-functionality"),
                    value: "",
                  },
                  { label: __("Yes", "porto-functionality"), value: "yes" },
                  { label: __("No", "porto-functionality"), value: "no" },
                ]}
                onChange={(value) => {
                  props.setAttributes({ autoplay: value });
                }}
    ...
    const PortoMembers = (props) => {
      ...
      const inspectorControls = (
        <InspectorControls>
          <PanelBody
            title={__("Member Layout", "porto-functionality")}
            initialOpen={true}
          >
            <TextControl
              label={__("Title", "porto-functionality")}
            ...
            <SelectControl
              ...
              value={attrs.style}
              options={[
                { label: __("Baisc", "porto-functionality"), value: "" },
                {
                  label: __("Advanced", "porto-functionality"),
                  value: "advanced",
                },
              ]}
              onChange={(value) => {
            ...
            <SelectControl
              ...
              options={[
                { label: __("Zoom", "porto-functionality"), value: "zoom" },
                {
                  label: __("No_Zoom", "porto-functionality"),
                  value: "no_zoom",
                },
              ]}
              onChange={(value) => {
                props.setAttributes({ hover_image_effect: value });
              }}
            />
            {"" === attrs.style && (
              <ToggleControl
                ...
                onChange={(value) => {
                  props.setAttributes({ overview: value });
                }}
              />
            )}
            <ToggleControl
              ...
              onChange={(value) => {
                props.setAttributes({ socials: value });
              }}
            />
          ...
          <PanelBody
            title={__("Members Selector", "porto-functionality")}
            initialOpen={false}
          >
            <PortoAjaxSelect2Control
              label={__("Categories", "porto-functionality")}
        ...
        <InspectorControls>
          ...
          >
            ...
            {attrs.socials && (
              <ToggleControl
                label={__(
                  "Use Social Links Advance Style",
                  "porto-functionality"
                )}
                checked={attrs.socials_style}
                onChange={(value) => {
                  props.setAttributes({ socials_style: value });
                }}
              />
            )}
            <RangeControl
  ...
  const PortoSidebarMenu = function (props) {
    ...
    const [menuList, setMenuList] = useState([
      { label: __("Select a menu", "porto-functionality"), value: "" },
    ]);
    ...
    var inspectorControls = el(
      ...
      el(SelectControl, {
        ...
        options: menuList,
        onChange: (value) => {
          props.setAttributes({ nav_menu: value });
        },
      })
    );
      ...
      <InspectorControls>
        ...
        >
          <SelectControl
            ...
            value={attrs.type}
            options={[
              { label: __("HTML", "porto-functionality"), value: "html" },
              { label: __("Product", "porto-functionality"), value: "product" },
              { label: __("Block", "porto-functionality"), value: "block" },
            ]}
            onChange={(value) => {
          ...
          {"block" === attrs.type && (
            <PortoAjaxSelect2Control
              ...
              onChange={(value) => {
                props.setAttributes({ block: Number(value) });
              }}
            />
          )}
          <TextControl
  ...
  const PortoSvgFloating = (props) => {
      ...
      <InspectorControls>
        ...
        >
          <TextareaControl
            ...
            onChange={(value) => {
              props.setAttributes({ float_svg: value });
            }}
          />
          <TextControl
            label={__(
              "Please write floating path id using comma. like #path1, #path2.",
              "porto-functionality"
            )}
            value={attrs.float_path}
            onChange={(value) => {
              props.setAttributes({ float_path: value });
            }}
          />
          <RangeControl
            ...
            max="99999"
            onChange={(value) => {
              props.setAttributes({ float_duration: value });
            }}
          />
          <SelectControl
            ...
            onChange={(value) => {
              props.setAttributes({ float_easing: value });
            }}
          />
          <RangeControl
            ...
            max="10000"
            onChange={(value) => {
              props.setAttributes({ float_repeat: value });
            }}
          />
          <RangeControl
            ...
            max="100000"
            onChange={(value) => {
              props.setAttributes({ float_repeat_delay: value });
            }}
          />
          <ToggleControl
            ...
            onChange={(value) => {
              props.setAttributes({ float_yoyo: value });
            }}
          />
        </PanelBody>
      </InspectorControls>
    ...
    var floatScript =
      "jQuery(document).ready(function($) {if (typeof KUTE != 'undefined') {";
    ...
    var renderControls = (
      <>
        <div
          className={attrs.el_class}
          dangerouslySetInnerHTML={{ __html: attrs.float_svg }}
        />
  ...
  const PortoPageContent = function (props) {
    return (
      <div class="porto-page-content">
        <span>
          {__(
            "This is Porto Page Content Block. It will displays the content of a post and page. This block is available only for Gutenberg Full Site Editing Mode. That might be different from the frontend.",
            "porto-functionality"
          )}
        </span>
      </div>
  ...
  registerBlockType("porto/porto-page-content", {
    ...
    description: __(
      "This will displays the content of a post and page.",
      "porto-functionality"
    ),
    icon: "porto",
    category: "porto",
  ...
  const PortoCountDown = function (props) {
    ...
    if (isFirstLoad) {
      ...
      for (let index = 0; index < scripts.length; index++) {
        if (!window.portoBlockDocument().getElementById(scripts[index])) {
          ...
          wf.id = scripts[index];
          wf.src =
            porto_block_vars.shortcodes_url + "assets/js/" + scripts[index];
    ...
    useEffect(() => {
      ...
      if ($countDown.length) {
        if (
          typeof $countDown.data("porto_countdown_initialized") !=
            "undefined" &&
          $countDown.data("porto_countdown_initialized")
        ) {
        ...
        let cdate = new Date(),
          sdate =
            cdate.getTime() +
            parseFloat(porto_block_vars.gmt_offset) * 3600 * 1000;
    ...
    var inspectorControls = (
      <InspectorControls>
        <PanelBody
          title={__("Countdown Timer", "porto-functionality")}
          initialOpen={true}
        >
          <SelectControl
            ...
            options={[
              {
                label: __("Inline", "porto-functionality"),
                value: "porto-cd-s1",
              },
              {
                label: __("Block", "porto-functionality"),
            ...
            onChange={(value) => {
              props.setAttributes({ count_style: value });
            }}
          />
          <ToggleControl
            ...
            onChange={(value) => {
              props.setAttributes({ enable_dynamic_date: value });
            }}
          />
          {attrs.enable_dynamic_date && (
          ...
          <SelectControl
            ...
            options={[
              {
                label: __("WordPress Defined Timezone", "porto-functionality"),
                value: "porto-wptz",
              },
              {
                label: __("User's System Timezone", "porto-functionality"),
                value: "porto-usrtz",
              },
            ]}
            onChange={(value) => {
              props.setAttributes({ porto_tz: value });
            }}
          />
          <SelectControl
            ...
            options={[
              { label: __("Years", "porto-functionality"), value: "syear" },
              { label: __("Months", "porto-functionality"), value: "smonth" },
              { label: __("Weeks", "porto-functionality"), value: "sweek" },
              { label: __("Days", "porto-functionality"), value: "sday" },
              { label: __("Hours", "porto-functionality"), value: "shr" },
              { label: __("Minutes", "porto-functionality"), value: "smin" },
              { label: __("Seconds", "porto-functionality"), value: "ssec" },
            ]}
            multiple={true}
            onChange={(value) => {
              props.setAttributes({ countdown_opts: value });
            }}
          />
          {"porto-cd-s2" != attrs.count_style && (
            <TextControl
              ...
              onChange={(value) => {
                props.setAttributes({ countdown_label: value });
              }}
            />
          )}
        </PanelBody>
        <PanelBody
          title={__("Texts", "porto-functionality")}
          initialOpen={false}
        >
          {attrs.countdown_opts &&
            -1 !== attrs.countdown_opts.indexOf("syear") && (
              <TextControl
                label={__("Year", "porto-functionality")}
                value={attrs.string_years}
                onChange={(value) => {
                  props.setAttributes({ string_years: value });
                }}
              />
            )}
          {attrs.countdown_opts &&
            -1 !== attrs.countdown_opts.indexOf("smonth") && (
              <TextControl
                label={__("Month", "porto-functionality")}
                value={attrs.string_months}
                onChange={(value) => {
                  props.setAttributes({ string_months: value });
                }}
              />
            )}
          {attrs.countdown_opts &&
            -1 !== attrs.countdown_opts.indexOf("sweek") && (
              <TextControl
                label={__("Week", "porto-functionality")}
                value={attrs.string_weeks}
                onChange={(value) => {
                  props.setAttributes({ string_weeks: value });
                }}
              />
            )}
          {attrs.countdown_opts &&
            -1 !== attrs.countdown_opts.indexOf("sday") && (
              <TextControl
                label={__("Day", "porto-functionality")}
                value={attrs.string_days}
                onChange={(value) => {
                  props.setAttributes({ string_days: value });
                }}
              />
            )}
          {attrs.countdown_opts &&
            -1 !== attrs.countdown_opts.indexOf("shr") && (
              <TextControl
                label={__("Hour", "porto-functionality")}
                value={attrs.string_hours}
                onChange={(value) => {
                  props.setAttributes({ string_hours: value });
                }}
              />
            )}
          {attrs.countdown_opts &&
            -1 !== attrs.countdown_opts.indexOf("smin") && (
              <TextControl
                label={__("Minute", "porto-functionality")}
                value={attrs.string_minutes}
                onChange={(value) => {
                  props.setAttributes({ string_minutes: value });
                }}
              />
            )}
          {attrs.countdown_opts &&
            -1 !== attrs.countdown_opts.indexOf("ssec") && (
              <TextControl
                label={__("Second", "porto-functionality")}
                value={attrs.string_seconds}
                onChange={(value) => {
                  props.setAttributes({ string_seconds: value });
                }}
              />
            )}
          ...
          {attrs.countdown_opts &&
            -1 !== attrs.countdown_opts.indexOf("syear") && (
              <TextControl
                ...
                onChange={(value) => {
                  props.setAttributes({ string_years2: value });
                }}
              />
            )}
          {attrs.countdown_opts &&
            -1 !== attrs.countdown_opts.indexOf("smonth") && (
              <TextControl
                ...
                onChange={(value) => {
                  props.setAttributes({ string_months2: value });
                }}
              />
            )}
          {attrs.countdown_opts &&
            -1 !== attrs.countdown_opts.indexOf("sweek") && (
              <TextControl
                ...
                onChange={(value) => {
                  props.setAttributes({ string_weeks2: value });
                }}
              />
            )}
          {attrs.countdown_opts &&
            -1 !== attrs.countdown_opts.indexOf("sday") && (
              <TextControl
                ...
                onChange={(value) => {
                  props.setAttributes({ string_days2: value });
                }}
              />
            )}
          {attrs.countdown_opts &&
            -1 !== attrs.countdown_opts.indexOf("shr") && (
              <TextControl
                ...
                onChange={(value) => {
                  props.setAttributes({ string_hours2: value });
                }}
              />
            )}
          {attrs.countdown_opts &&
            -1 !== attrs.countdown_opts.indexOf("smin") && (
              <TextControl
                ...
                onChange={(value) => {
                  props.setAttributes({ string_minutes2: value });
                }}
              />
            )}
          {attrs.countdown_opts &&
            -1 !== attrs.countdown_opts.indexOf("ssec") && (
              <TextControl
                ...
                onChange={(value) => {
                  props.setAttributes({ string_seconds2: value });
                }}
              />
            )}
        </PanelBody>
    ...
    var count_frmt = "",
      labels2 =
        ...
        attrs.string_hours +
        "," +
        attrs.string_minutes +
        "," +
        attrs.string_seconds,
      labels =
        attrs.string_years2 +
        "," +
        attrs.string_months2 +
        "," +
        attrs.string_weeks2 +
        "," +
        attrs.string_days2 +
        ...
        attrs.string_hours2 +
        "," +
        attrs.string_minutes2 +
        "," +
        attrs.string_seconds2,
      years = "",
      months = "",
      weeks = "",
      days = "",
      ...
      if (count_frmt) {
        ...
        if (difftime > 0) {
          ...
          if (attrs.countdown_opts.includes("shr")) {
            if (
              attrs.countdown_opts.includes("smin") ||
              attrs.countdown_opts.includes("ssec")
            ) {
    ...
    var renderControls = attrs.datetime && (
      <div className={attrs.el_class}>
        {attrs.countdown_label && "porto-cd-s2" != attrs.count_style && (
          <span className="countdown-label">{attrs.countdown_label}</span>
        )}
        <div
          className={format_cls}
          data-labels={labels}
          data-labels2={labels2}
          data-terminal-date={attrs.datetime}
          data-countformat={count_frmt}
          data-time-zone={porto_block_vars.gmt_offset}
        >
          {attrs.countdown_opts ? (
                ...
                return (
                  <span className="porto_coundown-section" key={index}>
                    <span className="porto_time-mid">
                      <span className="porto_countdown-amount">{amount}</span>
                      <span className="porto_countdown-period">{unit}</span>
                    </span>
                  </span>
                );
              })}
