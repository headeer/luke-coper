...
function porto_load_tag_cloud_shortcode() {
	...
	vc_map(
		array(
			...
			'icon'        => PORTO_WIDGET_URL . 'tag-cloud.png',
			...
			'params'      => array(
				...
				array(
					...
					'selectors'   => array(
						'{{WRAPPER}} .widget .tagcloud a' => 'margin-top:{{TOP}}; margin-right:{{RIGHT}}; margin-bottom:{{BOTTOM}}; margin-left: {{LEFT}};',
					),
					'group'       => esc_html__( 'Tag Style', 'porto-functionality' ),
				),
				array(
					...
					'selectors'   => array(
						'{{WRAPPER}} .widget .tagcloud a' => 'padding-top: {{TOP}};padding-right: {{RIGHT}};padding-bottom: {{BOTTOM}};padding-left: {{LEFT}};',
					),
					'group'       => esc_html__( 'Tag Style', 'porto-functionality' ),
				),
				array(
