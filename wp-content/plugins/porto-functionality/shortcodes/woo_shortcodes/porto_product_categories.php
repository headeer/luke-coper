			...
			'params'      => array_merge(
				array(
					...
					array(
						...
						'selectors'   => array(
							'{{WRAPPER}} .thumb-info i' => 'padding-top: {{TOP}}; padding-right: {{RIGHT}}; padding-bottom: {{BOTTOM}}; padding-left: {{LEFT}};',
						),
						'group'       => __( 'Style', 'porto-functionality' ),
					),
					array(
					...
					array(
						...
						'selectors'  => array(
							'{{WRAPPER}} .product-category:not(.cat-has-icon) .thumb-info .thumb-info-title' => 'padding-top:{{TOP}}; padding-right:{{RIGHT}}; padding-bottom:{{BOTTOM}}; padding-left:{{LEFT}};',
							'{{WRAPPER}} .product-category.cat-has-icon .thumb-info' => 'padding-top:{{TOP}}; padding-right:{{RIGHT}}; padding-bottom:{{BOTTOM}}; padding-left:{{LEFT}};',
						),
						'group'      => __( 'Text Style', 'porto-functionality' ),
					),
					$custom_class,
