...
class Porto_Contact_Info_Widget extends WP_Widget {
	...
	function form( $instance ) {
		$defaults = array(
			...
			'contact_before' => '',
			'address_label'  => '',
			'address'        => __( '1234 Street Name, City Name, Country Name', 'porto-functionality' ),
			'phone_label'    => '',
			'phone'          => __( '(123) 456-7890', 'porto-functionality' ),
			'email_label'    => '',
			'email'          => 'mail@example.com',
			'working_label'  => '',
			'working'        => __( 'Mon - Sun / 9:00 AM - 8:00 PM', 'porto-functionality' ),
			'contact_after'  => '',
			'view'           => 'inline',
			'icon'           => '',
		);
