...
//				}
                var palettes_color, option_name = this.getAttribute( 'data-id' );
                if ( option_name && -1 !== [ 'skin-color', 'skin-color-inverse', 'secondary-color', 'secondary-color-inverse', 'tertiary-color', 'tertiary-color-inverse', 'quaternary-color', 'quaternary-color-inverse', 'dark-color', 'dark-color-inverse', 'light-color', 'light-color-inverse', 'placeholder-color' ].indexOf( option_name ) ) {
                    palettes_color = ['#0088cc', '#3740ea', '#698a9f', '#222529', '#ffffff', '#e13b3f', '#7aa93c', '#4dae65'];
                } else {
                    palettes_color = [ 'var(--porto-primary-color)', 'var(--porto-secondary-color)', 'var(--porto-tertiary-color)', 'var(--porto-quaternary-color)', 'var(--porto-dark-color)', 'var(--porto-light-color)', 'var(--porto-primary-light-5)' ];
                }
                el.find( '.redux-color-init' ).wpColorPicker(
                    {
                        palettes: palettes_color,
