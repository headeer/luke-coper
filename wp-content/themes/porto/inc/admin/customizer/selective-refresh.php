		...
		array(
			...
			'render_callback'     => function() {
				if ( is_singular( 'post' ) ) {
					...
					return get_template_part( 'content', 'post-' . sanitize_file_name( $post_layout ) );
				}
				return '';
			},
		)
