...
function porto_wooc_extra_register_start_fields()
{
	...
	if (isset($porto_settings['reg-form-info']) && 'full' == $porto_settings['reg-form-info']):
		...
		<p class="form-row form-row-first">
			<label for="reg_billing_first_name"><?php esc_html_e('First Name', 'porto'); ?><span
		...
		<div class="after-loading-success-message style-<?php echo esc_attr($porto_settings['add-to-cart-notification']); ?>">
			<?php if (isset($porto_settings['add-to-cart-notification']) && 2 === (int) $porto_settings['add-to-cart-notification']): ?>
				...
				<div class="loader success-message-container">
					<div class="msg-box">
						<div class="msg"><?php esc_html_e("You've just added this product to the cart", 'porto'); ?>:<p
								class="product-name text-color-primary"></p>
						</div>
					</div>
					<button class="button btn-primay viewcart" data-link=""><?php esc_html_e('Koszyk', 'porto'); ?></button>
				...
				<div class="success-message-container d-none">
					<div class="msg-box">
						<div class="msg">
							...
							<?php printf(esc_html__('%s został dodany do koszyka.', 'porto'), '<div class="product-name"></div>'); ?>
						</div>
					</div>
					<button class="btn btn-modern btn-sm btn-gray viewcart btn-sm"
						data-link=""><?php esc_html_e('Koszyk', 'porto'); ?></button>
					<a class="btn btn-modern btn-sm btn-dark continue_shopping"
						href="<?php echo esc_url(function_exists('wc_get_checkout_url') ? wc_get_checkout_url() : wc_get_page_permalink('checkout')); ?>"><?php esc_html_e('Checkout', 'porto'); ?></a>
...
/**
 * Add 'Koszyk' button after add to cart
 * 
