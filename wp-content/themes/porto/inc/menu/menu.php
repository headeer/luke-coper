...
function porto_update_custom_nav_fields( $menu_id, $menu_item_db_id, $args ) {
	$check = array( 'icon', 'nolink', 'hide', 'mobile_hide', 'popup_mobile_hide', 'cols', 'popup_type', 'popup_pos', 'popup_cols', 'popup_max_width', 'popup_bg_image', 'popup_bg_pos', 'popup_bg_repeat', 'popup_bg_size', 'popup_style', 'block', 'tip_label', 'tip_color', 'tip_bg', 'preview', 'preview_fixed' );
		...
		<dt class="menu-item-handle">
			...
			<span class="item-controls">
				...
				<a class="item-edit" id="edit-<?php echo esc_attr( $item_id ); ?>" title="Edit Menu Item" href="<?php
					...
					?>"><?php esc_html_e( 'Edit Menu Item', 'porto' ); ?></a>
			</span>
		</dt>
	</dl>
