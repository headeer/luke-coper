...
<div id="content" role="main">
	...
	while (have_posts()):
								...
								if ($attachment) {
									...
									<div>
										<div class="img-thumbnail">
											<img class="owl-lazy img-responsive" width="<?php echo esc_attr($attachment['width']); ?>"
												height="<?php echo esc_attr($attachment['height']); ?>"
												data-src="<?php echo esc_url($attachment['src']); ?>"
												alt="<?php echo esc_attr($attachment['alt']); ?>" />
											<?php if ($porto_settings['page-zoom']): ?>
												<span class="zoom" data-src="<?php echo esc_attr($attachment['src']); ?>"
													data-title="<?php echo esc_attr($attachment['caption']); ?>"><i
		...
		if ($share_enabled || $comment_enabled):
			?>
			<div
				class="<?php echo 'wide-left-sidebar' == $porto_layout || 'wide-right-sidebar' == $porto_layout || 'wide-both-sidebar' == $porto_layout ? 'm-t-lg m-b-xl' : ''; ?>">
