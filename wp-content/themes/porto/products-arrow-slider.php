<div class="swiper-wrapper smaller_wishlist">
    ...
    while ($loop->have_posts()):
        ...
        <a href="<?php echo esc_url($product_link); ?>"
            class="swiper-slide t-frame-51ttbransoletka-miedziana-holistic-energy t-frame-51ttbransoletka-miedziana-holistic-energy-2">
            ...
            <div class="product-link">
                <img src="<?php echo $product_image[0]; ?>" class="frame-46"
                    data-image="<?php echo $product_image[0]; ?>"></img>
