...
if ( porto_header_type_is_side() ) :
	...
	if ( empty( $header_type ) ) :
		...
		<?php endif; ?>
			...
			.header-wrapper #header { display: flex; flex-direction: column; z-index: 1110;  width: 100%; padding-bottom: 0; background-color: <?php echo ! $is_dark ? '#fff' : '#222529'; ?>; box-shadow: 0 0 30px <?php echo ! $is_dark ? 'rgba(0, 0, 0, 0.05)' : 'rgba(255, 255, 255, 0.03)'; ?>  }
	...
	if ( porto_is_product() ) :
		...
		?>
			...
			@media (min-width: 767px) {
				body.single-product .sticky-product .container { padding-left: 15px; padding-right: 15px; }
			}
			@media (max-width: 768px) {
				...
				body.single-product .sticky-product.show-mobile .container,
