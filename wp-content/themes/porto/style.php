...
elseif ( empty( $header_type ) && porto_header_type_is_side() ) :
	...
	<?php if ( ! $side_mobile_visible ) : // default side layout ?>
		...
		<?php endif; ?>
			...
			.side-header-narrow-bar-top { height: auto; width: 100vw; flex-direction: row; align-items: center; padding: 0 <?php echo esc_html( $b['grid-gutter-width'] / 2 ); ?>px; }
...
<?php if ( $b['thumb-padding'] ) : ?>
	...
	<?php if ( class_exists( 'Woocommerce' ) ) : ?>
		...
		.product-image-slider.owl-carousel .img-thumbnail { width: 99.8%; padding: 3px; }
