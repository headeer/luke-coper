...
if ( $products->have_posts() ) :
	...
	<div class="upsells products">
		...
		<h2 class="slider-title"><span class="inline-title"><?php echo apply_filters( 'woocommerce_product_upsells_products_heading', esc_html__( 'You may also like&hellip;', 'woocommerce' ) ); ?></span><span class="line"></span></h2>
